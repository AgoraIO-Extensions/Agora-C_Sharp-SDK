...
export default function (
    ...
    const audioFrameObserver = callbacks.find((e) => e.name == "IAudioFrameObserver");
    const mccAudioFrameObserverResult = renderWithConfiguration({
        fileNameTemplatePath: path.join(__dirname, "callback_file_name2.mustache"),
        fileContentTemplatePath: path.join(__dirname, "callback_file_content2.mustache"),
        view: audioFrameObserver
    });
