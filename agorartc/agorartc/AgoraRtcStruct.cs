...
namespace agorartc
{
    ...
    public struct LastmileProbeConfig
    {
        /** Sets whether or not to test the uplink network. Some users, for example, the audience in a `LIVE_BROADCASTING` channel, do not need such a test:
		 - true: test.
		 - false: do not test. */
        public int probeUplink { set; get; }

        /** Sets whether or not to test the downlink network:
		 - true: test.
		 - false: do not test. */
        public int probeDownlink { set; get; }
    ...
    public struct LiveTranscoding
    {
        ...
        /** TranscodingUser
		 */
        public IntPtr transcodingUsers { set; get; }
		 ...
		 */
        public IntPtr watermark { set; get; }
		 ...
		 */
        public IntPtr backgroundImage { set; get; }
		 ...
		 * @since v3.1.0
		 */
        public IntPtr advancedFeatures { set; get; }
    ...
    public struct ChannelMediaRelayConfiguration
    {
		 ...
		 */
        public IntPtr destInfos { set; get; }
    ...
    public struct ChannelMediaOptions
    {
		 ...
		 */
        public int autoSubscribeAudio { set; get; }
		 ...
		 */
        public int autoSubscribeVideo { set; get; }
    }
