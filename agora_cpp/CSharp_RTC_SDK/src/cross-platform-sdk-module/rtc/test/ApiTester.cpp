...
void BeginApiTestWithString(const char *testCase,
                            APICaseHandler *apiCaseHandler) {
...
std::string
CompareAndDumpApiTestResultWithString(const char *testCase,
                                      APICaseHandler *apiCaseHandler) {
  return GetApiJsonLogger().compareAndDumpResult(testCase);
}
