...
void BeginRtcEngineEventTestWithJson(Document &caseDoc,
...
void BeginRtcEngineEventTest(const char *caseFilePath,
  ...
  BeginRtcEngineEventTestWithJson(caseDoc, eventHandler);
}
...
void BeginRtcEngineEventTestWithString(
    const char *testCase, RtcEngineEventHandlerBase *eventHandler) {
  GetEngineEventJsonLogger().clearJsonData();
  Document caseDoc;
  caseDoc.Parse(testCase);
...
std::string CompareAndDumpRtcEngineEventTestResultWithSring(
    const char *testCase, RtcEngineEventHandlerBase *eventHandler) {
  return GetEngineEventJsonLogger().compareAndDumpResult(testCase);
}
...
void BeginChannelEventTestWithJson(Document &caseDoc,
...
void BeginChannelEventTest(const char *caseFilePath,
  ...
  BeginChannelEventTestWithJson(caseDoc, rtcChannel, eventHandler);
}
...
std::string CompareAndDumpChannelEventTestResultWithString(
    ...
    RtcChannelEventHandlerBase *eventHandler) {
  return GetChannelEventJsonLogger().compareAndDumpResult(testCase);
}
