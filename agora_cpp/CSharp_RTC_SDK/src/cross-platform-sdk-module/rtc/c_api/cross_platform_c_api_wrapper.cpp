...
getUserInfoByUserAccount(IRtcEngineBridge_ptr apiBridge, const char* userAccount, struct UserInfo* userInfo)
{
    ...
    std::string uuu = std::string(info.userAccount);
    memcpy(userInfo->userAccount, info.userAccount, uuu.length());
...
setupLocalVideo(IRtcEngineBridge_ptr apiBridge, const struct VideoCanvas canvas)
{
    ...
    memcpy(videoCanvas.channelId, canvas.channelId, canvas.length);
...
audio_device_getDevice(void* apiBridge, enum DEVICE_TYPE type, int index, char deviceName[MAX_DEVICE_ID_LENGTH], char deviceId[MAX_DEVICE_ID_LENGTH])
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->getDevice(index, deviceName, deviceId));
...
audio_device_getCurrentDevice(void* apiBridge, enum DEVICE_TYPE type, char deviceId[MAX_DEVICE_ID_LENGTH])
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->getCurrentDevice(deviceId));
...
audio_device_getCurrentDeviceInfo(void* apiBridge, enum DEVICE_TYPE type, char deviceId[MAX_DEVICE_ID_LENGTH], char deviceName[MAX_DEVICE_ID_LENGTH])
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->getCurrentDeviceInfo(deviceId, deviceName));
...
audio_device_setDevice(void* apiBridge, enum DEVICE_TYPE type, const char deviceId[MAX_DEVICE_ID_LENGTH])
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->setDevice(deviceId));
...
audio_device_setDeviceVolume(void* apiBridge, enum DEVICE_TYPE type, int volume)
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->setDeviceVolume(volume));
...
audio_device_getDeviceVolume(void* apiBridge, enum DEVICE_TYPE type, int* volume)
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->getDeviceVolume(volume));
...
audio_device_setDeviceMute(void* apiBridge, enum DEVICE_TYPE type, BOOL mute)
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->setDeviceMute(mute));
...
audio_device_getDeviceMute(void* apiBridge, enum DEVICE_TYPE type, BOOL* mute)
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE: {
        bool mutes1;
        ERROR_CODE error_code1 = ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->getDeviceMute(&mutes1));
        *mute = mutes1;
        return error_code1;
    }
...
audio_device_startDeviceTest(void* apiBridge, enum DEVICE_TYPE type, const char* testAudioFilePath, int indicationInterval)
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->startDeviceTest(indicationInterval));
...
audio_device_startAudioDeviceLoopbackTest(void* apiBridge, enum DEVICE_TYPE type, int indicationInterval)
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->startAudioDeviceLoopbackTest(indicationInterval));
...
audio_device_stopAudioDeviceLoopbackTest(void* apiBridge, enum DEVICE_TYPE type)
{
    ...
    case DEVICE_TYPE::RECORDING_DEVICE:
        return ERROR_CODE(AudioRecordingDeviceManagerBridge_ptr->stopAudioDeviceLoopbackTest());
...
{
    CHECK_PTR_INT(apiBridge)
    return VideoDeviceManagerBridge_ptr->getDeviceCount();
}
