...
// Modified by Yiqing Huang on 2020-11-27
//
...
typedef void (*FUNC_OnAudioVolumeIndication)(uid_t* uid, unsigned int* volume, unsigned int* vad, const char** channelId, int speakerNumber, int totalVolume);
...
struct RtcEventHandler {
    FUNC_OnJoinChannelSuccess onJoinChannelSuccess;
    ...
    FUNC_OnTestEnd onTestEnd;
};

struct ChannelEventHandler {
    FUNC_OnChannelWarning onWarning;
    ...
    FUNC_OnChannelTestEnd onTestEnd;
};
...
extern "C" DllExport IRtcEngineBridge_ptr
createRtcBridge();

extern "C" DllExport void
release(IRtcEngineBridge_ptr apiBridge, BOOL sync);

extern "C" DllExport IRtcChannelBridge_ptr
createChannel(IRtcEngineBridge_ptr apiBridge, const char* channelId);

extern "C" DllExport void
releaseChannel(IRtcChannelBridge_ptr apiBridge);

extern "C" DllExport IAudioPlaybackDeviceManager_ptr
...
extern "C" DllExport IAudioRecordingDeviceManager_ptr
...
extern "C" DllExport IVideoDeviceManager_ptr
createVideoDeviceManager(IRtcEngineBridge_ptr apiBridge);

extern "C" DllExport void
releaseVideoDeviceManager(IVideoDeviceManager_ptr apiBridge);

extern "C" DllExport enum ERROR_CODE
...
isSpeakerphoneEnabled(IRtcEngineBridge_ptr apiBridge);
#endif
...
extern "C" DllExport enum CONNECTION_STATE_TYPE
...
extern "C" DllExport enum ERROR_CODE
enableEncryption(IRtcEngineBridge_ptr apiBridge, BOOL enabled, const struct EncryptionConfig config);

extern "C" DllExport enum ERROR_CODE
sendCustomReportMessage(IRtcEngineBridge_ptr apiBridge, const char* id, const char* category, const char* event, const char* label, int value);

extern "C" DllExport void
channel_add_C_ChannelEventHandler(IRtcChannelBridge_ptr apiBridge, struct ChannelEventHandler* channelEventHandler);
...
audio_device_getCount(void* apiBridge, enum DEVICE_TYPE type);
...
extern "C" DllExport enum ERROR_CODE
audio_device_startDeviceTest(void* apiBridge, enum DEVICE_TYPE type, const char* testAudioFilePath, int indicationInterval);
...
extern "C" DllExport int
getDeviceCount(IVideoDeviceManager_ptr apiBridge);

//int
//channel_registerMediaMetadataObserver(IRtcChannelBridge_ptr apiBridge, IMetadataObserver *observer, rtc::IMetadataObserver::METADATA_TYPE type,  bool useSdkDefault = true);
...
extern "C" DllExport void begin_api_test(const char *caseFilePath,
                    FUNC_APICaseHandler apiCaseHandler);

extern "C" DllExport void compare_and_dump_api_test_result(const char *caseFilePath,
                                      const char *dumpFilePath,
                                      FUNC_APICaseHandler apiCaseHandler);

extern "C" DllExport void begin_rtc_engine_event_test(const char *caseFilePath,
                                 struct RtcEventHandler *eventHandler);
extern "C" DllExport void compare_dump_rtc_engine_event_test_result(const char *caseFilePath,
                                               const char *dumpFilePath,
                                               struct RtcEventHandler *eventHandler);
extern "C" DllExport void log_engine_event_case(const char *eventType, const char *parameter);

extern "C" DllExport void begin_channel_event_test(const char *caseFilePath, const char *channelId,
                              struct ChannelEventHandler *eventHandler);
extern "C" DllExport void compare_dump_channel_event_test_result(const char *caseFilePath,
                                            const char *dumpFilePath,
                                            const char *channelId,
                                            struct ChannelEventHandler *eventHandler);
extern "C" DllExport void log_channel_event_case(const char *eventType, const char *parameter);
