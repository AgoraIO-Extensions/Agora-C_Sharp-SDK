...
typedef void(__stdcall* FUNC_OnAudioVolumeIndication)(uid_t* uid, unsigned int* volume, unsigned int* vad, const char** channelId, int speakerNumber, int totalVolume);
...
typedef void(__stdcall* FUNC_OnLocalUserRegistered)(uid_t uid, const char* userAccount);
...
// raw data callback
typedef void(__stdcall* FUNC_OnCaptureVideoFrame)(int videoFrameType, int width, int height, int yStride, void* yBuffer, int rotation, long long renderTimeMs);
typedef void(__stdcall* FUNC_OnRenderVideoFrame)(unsigned int uid, int videoFrameType, int width, int height, int yStride, void* yBuffer, int rotation, long long renderTimeMs);
typedef void(__stdcall* FUNC_OnRecordAudioFrame)(int type, int samples, int bytesPerSample, int channels, int samplesPerSec, void* buffer, long long renderTimeMs, int avsync_type);
typedef void(__stdcall* FUNC_OnPlaybackAudioFrame)(int type, int samples, int bytesPerSample, int channels, int samplesPerSec, void* buffer, long long renderTimeMs, int avsync_type);
typedef void(__stdcall* FUNC_OnPullAudioFrame)(int type, int samples, int bytesPerSample, int channels, int samplesPerSec, void* buffer, long long renderTimeMs, int avsync_type);
typedef void(__stdcall* FUNC_OnMixedAudioFrame)(int type, int samples, int bytesPerSample, int channels, int samplesPerSec, void* buffer, long long renderTimeMs, int avsync_type);
typedef void(__stdcall* FUNC_OnPlaybackAudioFrameBeforeMixing)(unsigned int uid, int type, int samples, int bytesPerSample, int channels, int samplesPerSec, void* buffer, long long renderTimeMs, int avsync_type);
