...
namespace common {
    ...
    typedef void (*FUNC_OnChannelJoinChannelSuccess)(const char* channelId, rtc::uid_t uid, int elapsed);
    typedef void (*FUNC_OnChannelReJoinChannelSuccess)(const char* channelId, rtc::uid_t uid, int elapsed);
    ...
    typedef void (*FUNC_OnChannelUserJoined)(const char* channelId, rtc::uid_t uid, int elapsed);
    typedef void (*FUNC_OnChannelUserOffLine)(const char* channelId, rtc::uid_t uid, int reason);
    ...
    typedef void (*FUNC_OnChannelNetworkQuality)(const char* channelId, rtc::uid_t uid, int txQuality, int rxQuality);
    typedef void (*FUNC_OnChannelRemoteVideoStats)(const char* channelId, rtc::uid_t uid, int delay, int width, int height, int receivedBitrate, int decoderOutputFrameRate, int rendererOutputFrameRate, int packetLossRate, int rxStreamType, int totalFrozenTime, int frozenRate, int totalActiveTime);
    typedef void (*FUNC_OnChannelRemoteAudioStats)(const char* channelId, rtc::uid_t uid, int quality, int networkTransportDelay, int jitterBufferDelay, int audioLossRate, int numChannels, int receivedSampleRate, int receivedBitrate, int totalFrozenTime, int frozenRate, int totalActiveTime);
    typedef void (*FUNC_OnChannelRemoteAudioStateChanged)(const char* channelId, rtc::uid_t uid, int state, int reason, int elapsed);
    typedef void (*FUNC_OnChannelActiveSpeaker)(const char* channelId, rtc::uid_t uid);
    typedef void (*FUNC_OnChannelVideoSizeChanged)(const char* channelId, rtc::uid_t uid, int width, int height, int rotation);
    typedef void (*FUNC_OnChannelRemoteVideoStateChanged)(const char* channelId, rtc::uid_t uid, int state, int reason, int elapsed);
    typedef void (*FUNC_OnChannelStreamMessage)(const char* channelId, rtc::uid_t uid, int streamId, const char* data, size_t length);
    typedef void (*FUNC_OnChannelStreamMessageError)(const char* channelId, rtc::uid_t uid, int streamId, int code, int missed, int cached);
    ...
    typedef void (*FUNC_OnChannelStreamInjectedStatus)(const char* channelId, const char* url, rtc::uid_t uid, int status);
    typedef void (*FUNC_OnChannelRemoteSubscribeFallbackToAudioOnly)(const char* channelId, rtc::uid_t uid, BOOL isFallbackOrRecover);
