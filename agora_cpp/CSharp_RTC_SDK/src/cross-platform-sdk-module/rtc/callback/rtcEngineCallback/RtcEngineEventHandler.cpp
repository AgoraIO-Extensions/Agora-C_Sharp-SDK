...
namespace common {
    ...
    void RtcEngineEventHandler::initCallbackEvent(CEngineEventHandler* engineEventHandler)
    {
        cEngineEventHandler->onJoinChannelSuccess = engineEventHandler->onJoinChannelSuccess;
        cEngineEventHandler->onReJoinChannelSuccess = engineEventHandler->onReJoinChannelSuccess;
        ...
        cEngineEventHandler->onConnectionInterrupted = engineEventHandler->onConnectionInterrupted;
        ...
        cEngineEventHandler->onAudioVolumeIndication = engineEventHandler->onAudioVolumeIndication;
        ...
        cEngineEventHandler->onAudioMixingFinished = engineEventHandler->onAudioMixingFinished;
        cEngineEventHandler->onAudioRouteChanged = engineEventHandler->onAudioRouteChanged;
        cEngineEventHandler->onFirstRemoteVideoDecoded = engineEventHandler->onFirstRemoteVideoDecoded;
        cEngineEventHandler->onVideoSizeChanged = engineEventHandler->onVideoSizeChanged;
        cEngineEventHandler->onClientRoleChanged = engineEventHandler->onClientRoleChanged;
        cEngineEventHandler->onUserMuteVideo = engineEventHandler->onUserMuteVideo;
        cEngineEventHandler->onMicrophoneEnabled = engineEventHandler->onMicrophoneEnabled;
        cEngineEventHandler->onApiCallExecuted = engineEventHandler->onApiCallExecuted;
        cEngineEventHandler->onFirstLocalAudioFrame = engineEventHandler->onFirstLocalAudioFrame;
        cEngineEventHandler->onFirstRemoteAudioFrame = engineEventHandler->onFirstRemoteAudioFrame;
        cEngineEventHandler->onLastmileQuality = engineEventHandler->onLastmileQuality;
        cEngineEventHandler->onAudioQuality = engineEventHandler->onAudioQuality;
        cEngineEventHandler->onStreamInjectedStatus = engineEventHandler->onStreamInjectedStatus;
        cEngineEventHandler->onStreamUnpublished = engineEventHandler->onStreamUnpublished;
        cEngineEventHandler->onStreamPublished = engineEventHandler->onStreamPublished;
        cEngineEventHandler->onStreamMessageError = engineEventHandler->onStreamMessageError;
        cEngineEventHandler->onStreamMessage = engineEventHandler->onStreamMessage;
        cEngineEventHandler->onConnectionBanned = engineEventHandler->onConnectionBanned;
        cEngineEventHandler->onVideoStopped = engineEventHandler->onVideoStopped;
        cEngineEventHandler->onTokenPrivilegeWillExpire = engineEventHandler->onTokenPrivilegeWillExpire;
        cEngineEventHandler->onNetworkQuality = engineEventHandler->onNetworkQuality;
        cEngineEventHandler->onLocalVideoStats = engineEventHandler->onLocalVideoStats;
        cEngineEventHandler->onRemoteVideoStats = engineEventHandler->onRemoteVideoStats;
        cEngineEventHandler->onRemoteAudioStats = engineEventHandler->onRemoteAudioStats;
        cEngineEventHandler->onFirstLocalVideoFrame = engineEventHandler->onFirstLocalVideoFrame;
        cEngineEventHandler->onFirstRemoteVideoFrame = engineEventHandler->onFirstRemoteVideoFrame;
        cEngineEventHandler->onUserEnableVideo = engineEventHandler->onUserEnableVideo;
        cEngineEventHandler->onAudioDeviceStateChanged = engineEventHandler->onAudioDeviceStateChanged;
        cEngineEventHandler->onCameraReady = engineEventHandler->onCameraReady;
        cEngineEventHandler->onCameraFocusAreaChanged = engineEventHandler->onCameraFocusAreaChanged;
        cEngineEventHandler->onCameraExposureAreaChanged = engineEventHandler->onCameraExposureAreaChanged;
        cEngineEventHandler->onRemoteAudioMixingBegin = engineEventHandler->onRemoteAudioMixingBegin;
        cEngineEventHandler->onRemoteAudioMixingEnd = engineEventHandler->onRemoteAudioMixingEnd;
        cEngineEventHandler->onAudioEffectFinished = engineEventHandler->onAudioEffectFinished;
        cEngineEventHandler->onVideoDeviceStateChanged = engineEventHandler->onVideoDeviceStateChanged;
        cEngineEventHandler->onRemoteVideoStateChanged = engineEventHandler->onRemoteVideoStateChanged;
        cEngineEventHandler->onUserEnableLocalVideo = engineEventHandler->onUserEnableLocalVideo;
        cEngineEventHandler->onLocalPublishFallbackToAudioOnly = engineEventHandler->onLocalPublishFallbackToAudioOnly;
        cEngineEventHandler->onRemoteSubscribeFallbackToAudioOnly = engineEventHandler->onRemoteSubscribeFallbackToAudioOnly;
        cEngineEventHandler->onConnectionStateChanged = engineEventHandler->onConnectionStateChanged;
        cEngineEventHandler->onRemoteVideoTransportStats = engineEventHandler->onRemoteVideoTransportStats;
        cEngineEventHandler->onRemoteAudioTransportStats = engineEventHandler->onRemoteAudioTransportStats;
        cEngineEventHandler->onTranscodingUpdated = engineEventHandler->onTranscodingUpdated;
        cEngineEventHandler->onAudioDeviceVolumeChanged = engineEventHandler->onAudioDeviceVolumeChanged;
        cEngineEventHandler->onActiveSpeaker = engineEventHandler->onActiveSpeaker;
        cEngineEventHandler->onMediaEngineStartCallSuccess = engineEventHandler->onMediaEngineStartCallSuccess;
        cEngineEventHandler->onMediaEngineLoadSuccess = engineEventHandler->onMediaEngineLoadSuccess;
        cEngineEventHandler->onAudioMixingStateChanged = engineEventHandler->onAudioMixingStateChanged;
        cEngineEventHandler->onFirstRemoteAudioDecoded = engineEventHandler->onFirstRemoteAudioDecoded;
        cEngineEventHandler->onLocalVideoStateChanged = engineEventHandler->onLocalVideoStateChanged;
        cEngineEventHandler->onRtmpStreamingStateChanged = engineEventHandler->onRtmpStreamingStateChanged;
        cEngineEventHandler->onNetworkTypeChanged = engineEventHandler->onNetworkTypeChanged;
        cEngineEventHandler->onLastmileProbeResult = engineEventHandler->onLastmileProbeResult;
        cEngineEventHandler->onLocalUserRegistered = engineEventHandler->onLocalUserRegistered;
        cEngineEventHandler->onUserInfoUpdated = engineEventHandler->onUserInfoUpdated;
        cEngineEventHandler->onLocalAudioStateChanged = engineEventHandler->onLocalAudioStateChanged;
        cEngineEventHandler->onRemoteAudioStateChanged = engineEventHandler->onRemoteAudioStateChanged;
        cEngineEventHandler->onLocalAudioStats = engineEventHandler->onLocalAudioStats;
    ...
    void
    RtcEngineEventHandler::onJoinChannelSuccess(const char* channel, rtc::uid_t uid, int elapsed)
    {
        ...
        mEventHandler->functionCall<std::string, rtc::uid_t, int>("onJoinChannelSuccess",
            mChannel,
            uid,
            elapsed);
    }
        ...
        int elapsed)
    {
        ...
        std::string mChannel = channel ? channel : "";
        mEventHandler->functionCall<std::string, rtc::uid_t, int>("onRejoinChannelSuccess",
            mChannel,
            uid,
            elapsed);
    }
    ...
    void
    RtcEngineEventHandler::onUserJoined(rtc::uid_t uid, int elapsed)
    {
    ...
    void
    RtcEngineEventHandler::onClientRoleChanged(rtc::CLIENT_ROLE_TYPE oldRole,
    ...
    void
    RtcEngineEventHandler::onUserOffline(rtc::uid_t uid, rtc::USER_OFFLINE_REASON_TYPE reason)
    {
    ...
    void
    RtcEngineEventHandler::onUserMuteAudio(rtc::uid_t uid, bool muted)
    {
    ...
    void
    RtcEngineEventHandler::onFirstRemoteVideoDecoded(rtc::uid_t uid,
        int width,
        int height,
        int elapsed)
    {
        ...
        mEventHandler->functionCall<rtc::uid_t, int, int, int>("onFirstRemoteVideoDecoded",
            uid,
            width,
            height,
            elapsed);
    ...
    void
    RtcEngineEventHandler::onUserMuteVideo(rtc::uid_t uid, bool muted)
    {
    ...
    void
    RtcEngineEventHandler::onAudioRouteChanged(rtc::AUDIO_ROUTE_TYPE routing)
    {
    ...
    void
    RtcEngineEventHandler::onAudioVolumeIndication(const rtc::AudioVolumeInfo* speakers,
        ...
        int totalVolume)
    {
        ...
        if (cEngineEventHandler && cEngineEventHandler->onAudioVolumeIndication) {
            ...
            for (int i = 0; i < speakerNumber; i++) {
                ...
                agora::LogHelper::getInstance("./Log.txt").writeLog("onAudioVolumeIncaiton  uid: %u, volume: %u, vadList: %u, channelId: %s , ---- %u, %u, %u", uidList[i], volumeList[i], vadList[i], channelIdList[i], speakers[i].uid, speakers[i].volume, speakers[i].vad);
            }
            cEngineEventHandler->onAudioVolumeIndication(uidList.data(), volumeList.data(), vadList.data(), channelIdList.data(), speakerNumber, totalVolume);
        }
    ...
    void
    RtcEngineEventHandler::onRtcStats(const rtc::RtcStats& stats)
    {
        if (cEngineEventHandler && cEngineEventHandler->onRtcStats)
            cEngineEventHandler->onRtcStats(stats.duration, stats.txBytes, stats.rxBytes, stats.txAudioBytes, stats.txVideoBytes, stats.rxAudioBytes, stats.rxVideoBytes, stats.txKBitRate, stats.rxKBitRate, stats.rxAudioKBitRate, stats.txAudioKBitRate, stats.rxVideoKBitRate, stats.txVideoKBitRate, stats.lastmileDelay, stats.txPacketLossRate, stats.rxPacketLossRate, stats.userCount, stats.cpuAppUsage, stats.cpuTotalUsage, stats.gatewayRtt, stats.memoryAppUsageRatio, stats.memoryTotalUsageRatio, stats.memoryAppUsageInKbytes);
    ...
    void
    RtcEngineEventHandler::onVideoSizeChanged(rtc::uid_t uid, int width, int height,
        int rotation)
    {
        ...
        mEventHandler->functionCall<rtc::uid_t, int, int, int>("onVideoSizeChanged",
            uid,
            width,
            height,
            rotation);
    ...
    void
    RtcEngineEventHandler::onFirstRemoteAudioFrame(rtc::uid_t uid, int elapsed)
    {
        ...
        mEventHandler->functionCall<rtc::uid_t, int>("onFirstRemoteAudioFrame", uid, elapsed);
    }
    ...
    RtcEngineEventHandler::onLastmileProbeResult(const LastmileProbeResult& result)
    {
        if (cEngineEventHandler && cEngineEventHandler->onLastmileProbeResult)
            cEngineEventHandler->onLastmileProbeResult((int)result.state, result.uplinkReport.packetLossRate, result.uplinkReport.jitter, result.uplinkReport.availableBandwidth, result.downlinkReport.packetLossRate, result.downlinkReport.jitter, result.downlinkReport.availableBandwidth, result.rtt);
    ...
    void
    RtcEngineEventHandler::onAudioQuality(rtc::uid_t uid,
        int quality,
        ...
        unsigned short lost)
    {
        ...
        mEventHandler
            ->functionCall<rtc::uid_t, int, unsigned short, unsigned short>("onAudioQuality",
                uid,
                quality,
                delay,
                lost);
    ...
    void
    RtcEngineEventHandler::onRemoteVideoTransportStats(rtc::uid_t uid,
        unsigned short delay,
        unsigned short lost,
        unsigned short rxKBitRate)
    {
        if (cEngineEventHandler && cEngineEventHandler->onRemoteVideoTransportStats)
            cEngineEventHandler->onRemoteVideoTransportStats(uid, delay, lost, rxKBitRate);

        if (!mEventHandler)
            return;

        mEventHandler->functionCall<rtc::uid_t, unsigned short, unsigned short, unsigned short>(
    ...
    void
    RtcEngineEventHandler::onRemoteAudioTransportStats(rtc::uid_t uid,
        unsigned short delay,
        unsigned short lost,
        unsigned short rxKBitRate)
    {
        if (cEngineEventHandler && cEngineEventHandler->onRemoteAudioTransportStats)
            cEngineEventHandler->onRemoteAudioTransportStats(uid, delay, lost, rxKBitRate);
    ...
    void
    RtcEngineEventHandler::onStreamInjectedStatus(const char* url, rtc::uid_t uid, int status)
    {
        ...
        mEventHandler->functionCall<std::string, rtc::uid_t, int>("onStreamInjectedStatus",
            mUrl,
            uid,
            status);
    }
        ...
        bool muted)
    {
        if (cEngineEventHandler && cEngineEventHandler->onAudioDeviceVolumeChanged)
            cEngineEventHandler->onAudioDeviceVolumeChanged(int(deviceType), volume, muted);
    ...
    void
    RtcEngineEventHandler::onActiveSpeaker(rtc::uid_t uid)
    {
    ...
    void
    RtcEngineEventHandler::onStreamMessageError(rtc::uid_t uid,
        int streamId,
        int code,
        int missed,
        int cached)
    {
        if (cEngineEventHandler && cEngineEventHandler->onStreamMessageError)
            cEngineEventHandler->onStreamMessageError(uid, streamId, code, missed, cached);

        if (!mEventHandler)
            return;

        mEventHandler->functionCall<rtc::uid_t, int, int, int, int>("onStreamMessageError",
            uid,
            streamId,
            code,
            missed,
    ...
    void
    RtcEngineEventHandler::onStreamMessage(rtc::uid_t uid,
        int streamId,
        const char* data,
        size_t length)
    {
        ...
        mEventHandler->functionCall<rtc::uid_t, int, const char*, size_t>("onStreamMessage",
            uid,
            streamId,
            data,
            length);
    ...
    void
    RtcEngineEventHandler::onNetworkQuality(rtc::uid_t uid, int txQuality, int rxQuality)
    {
        ...
        mEventHandler
            ->functionCall<rtc::uid_t, int, int>("onNetworkQuality", uid, txQuality, rxQuality);
    }
    ...
    RtcEngineEventHandler::onLocalAudioStats(const LocalAudioStats& stats)
    {
        if (cEngineEventHandler && cEngineEventHandler->onLocalAudioStats)
            cEngineEventHandler->onLocalAudioStats(stats.numChannels, stats.sentSampleRate, stats.sentBitrate);
    ...
    RtcEngineEventHandler::onRemoteVideoStats(const RemoteVideoStats& stats)
    {
        if (cEngineEventHandler && cEngineEventHandler->onRemoteVideoStats)
            cEngineEventHandler->onRemoteVideoStats(stats.uid, stats.delay, stats.width, stats.height, stats.receivedBitrate, stats.decoderOutputFrameRate, stats.rendererOutputFrameRate, stats.packetLossRate, (int)stats.rxStreamType, stats.totalFrozenTime, stats.frozenRate, stats.totalActiveTime);
    ...
    RtcEngineEventHandler::onRemoteAudioStats(const RemoteAudioStats& stats)
    {
        if (cEngineEventHandler && cEngineEventHandler->onRemoteAudioStats)
            cEngineEventHandler->onRemoteAudioStats(stats.uid, stats.quality, stats.networkTransportDelay, stats.jitterBufferDelay, stats.audioLossRate, stats.numChannels, stats.receivedSampleRate, stats.receivedBitrate, stats.totalFrozenTime, stats.frozenRate, stats.totalActiveTime);
    ...
    void
    RtcEngineEventHandler::onFirstRemoteVideoFrame(rtc::uid_t uid,
        int width,
        int height,
        int elapsed)
    {
        ...
        mEventHandler->functionCall<rtc::uid_t, int, int, int>("onFirstRemoteVideoFrame",
            uid,
            width,
            height,
            elapsed);
    ...
    void
    RtcEngineEventHandler::onUserEnableVideo(rtc::uid_t uid, bool enabled)
    {
        ...
        mEventHandler->functionCall<rtc::uid_t, bool>("onUserEnableVideo", uid, enabled);
    }
        ...
        int deviceState)
    {
        if (cEngineEventHandler && cEngineEventHandler->onAudioDeviceStateChanged)
            cEngineEventHandler->onAudioDeviceStateChanged(deviceId, deviceType, deviceState);
        ...
        int deviceState)
    {
        if (cEngineEventHandler && cEngineEventHandler->onVideoDeviceStateChanged)
            cEngineEventHandler->onVideoDeviceStateChanged(deviceId, deviceType, deviceState);
    ...
    void
    RtcEngineEventHandler::onRemoteVideoStateChanged(rtc::uid_t uid,
        REMOTE_VIDEO_STATE state,
        REMOTE_VIDEO_STATE_REASON reason,
        int elapsed)
    {
        if (cEngineEventHandler && cEngineEventHandler->onRemoteVideoStateChanged)
            cEngineEventHandler->onRemoteVideoStateChanged(uid, int(state), int(reason), elapsed);

        if (!mEventHandler)
            return;

        mEventHandler->functionCall<rtc::uid_t, int, int, int>("onRemoteVideoStateChanged",
            uid,
            state,
            reason,
            elapsed);
    ...
    void
    RtcEngineEventHandler::onUserEnableLocalVideo(rtc::uid_t uid, bool enabled)
    {
        ...
        mEventHandler->functionCall<rtc::uid_t, bool>("onUserEnableLocalVideo", uid, enabled);
    }

    void
    RtcEngineEventHandler::onLocalPublishFallbackToAudioOnly(bool isFallbackOrRecover)
    {
        if (cEngineEventHandler && cEngineEventHandler->onLocalPublishFallbackToAudioOnly)
    ...
    void
    RtcEngineEventHandler::onRemoteSubscribeFallbackToAudioOnly(rtc::uid_t uid,
        bool isFallbackOrRecover)
    {
        if (cEngineEventHandler && cEngineEventHandler->onRemoteSubscribeFallbackToAudioOnly)
            cEngineEventHandler->onRemoteSubscribeFallbackToAudioOnly(uid, isFallbackOrRecover);

        if (!mEventHandler)
            return;

        mEventHandler->functionCall<rtc::uid_t, bool>("onRemoteSubscribeFallbackToAudioOnly",
            uid,
            isFallbackOrRecover);
    }
    ...
    void
    RtcEngineEventHandler::onFirstRemoteAudioDecoded(rtc::uid_t uid, int elapsed)
    {
        ...
        mEventHandler->functionCall<rtc::uid_t, int>("onFirstRemoteAudioDecoded", uid, elapsed);
    }
        ...
        LOCAL_VIDEO_STREAM_ERROR error)
    {
        if (cEngineEventHandler && cEngineEventHandler->onLocalVideoStateChanged)
            cEngineEventHandler->onLocalVideoStateChanged(int(localVideoState), int(error));
        ...
        RTMP_STREAM_PUBLISH_ERROR errCode)
    {
        if (cEngineEventHandler && cEngineEventHandler->onRtmpStreamingStateChanged)
            cEngineEventHandler->onRtmpStreamingStateChanged(url, int(state), int(errCode));
    ...
    void
    RtcEngineEventHandler::onLocalUserRegistered(rtc::uid_t uid, const char* userAccount)
    {
        ...
        mEventHandler
            ->functionCall<rtc::uid_t, std::string>("onLocalUserRegistered", uid, mUserAccount);
    }

    void
    RtcEngineEventHandler::onUserInfoUpdated(rtc::uid_t uid, const UserInfo& info)
    {
        if (cEngineEventHandler && cEngineEventHandler->onUserInfoUpdated)
            cEngineEventHandler->onUserInfoUpdated(uid, info.uid, (char*)info.userAccount);
    ...
    void
    RtcEngineEventHandler::onRemoteAudioStateChanged(rtc::uid_t uid,
        REMOTE_AUDIO_STATE state,
        REMOTE_AUDIO_STATE_REASON reason,
        int elapsed)
    {
        if (cEngineEventHandler && cEngineEventHandler->onRemoteAudioStateChanged)
            cEngineEventHandler->onRemoteAudioStateChanged(uid, int(state), int(reason), elapsed);

        if (!mEventHandler)
            return;

        mEventHandler->functionCall<rtc::uid_t, int, int, int>("onRemoteAudioStateChanged",
            uid,
            state,
            reason,
            elapsed);
    ...
    {
        if (cEngineEventHandler && cEngineEventHandler->onChannelMediaRelayStateChanged)
    ...
    RtcEngineEventHandler::onFacePositionChanged(int imageWidth,
        ...
        int numFaces)
    {
        if (cEngineEventHandler && cEngineEventHandler->onFacePositionChanged && vecRectangle && vecDistance)
            cEngineEventHandler->onFacePositionChanged(imageWidth, imageHeight, vecRectangle->x, vecRectangle->y, vecRectangle->width, vecRectangle->height, *vecDistance, numFaces);
