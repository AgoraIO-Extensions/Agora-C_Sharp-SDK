...
namespace agora
{
	namespace common
	{
		...
		typedef void (*FUNC_OnAudioVolumeIndication)(rtc::uid_t* uid, unsigned int* volume, unsigned int* vad, const char** channelId, int speakerNumber, int totalVolume);
		...
		typedef void (*FUNC_OnFirstRemoteVideoDecoded)(rtc::uid_t uid, int width, int height, int elapsed);
		typedef void (*FUNC_OnVideoSizeChanged)(rtc::uid_t uid, int width, int height, int elapsed);
		...
		typedef void (*FUNC_OnAudioQuality)(rtc::uid_t userId, int quality, unsigned short delay, unsigned short lost);
		typedef void (*FUNC_OnStreamInjectedStatus)(const char* url, rtc::uid_t userId, int status);
		typedef void (*FUNC_OnStreamUnpublished)(const char* url);
		typedef void (*FUNC_OnStreamPublished)(const char* url, int error);
		typedef void (*FUNC_OnStreamMessageError)(rtc::uid_t userId, int streamId, int code, int missed, int cached);
		typedef void (*FUNC_OnStreamMessage)(rtc::uid_t userId, int streamId, const char* data, size_t length);
		typedef void (*FUNC_OnConnectionBanned)();
		typedef void (*FUNC_OnRemoteVideoTransportStats)(rtc::uid_t uid, unsigned short delay, unsigned short lost, unsigned short rxKBitRate);
		typedef void (*FUNC_OnRemoteAudioTransportStats)(rtc::uid_t uid, unsigned short delay, unsigned short lost, unsigned short rxKBitRate);
		...
		typedef void (*FUNC_OnNetworkQuality)(rtc::uid_t uid, int txQuality, int rxQuality);
		...
		typedef void (*FUNC_OnRemoteVideoStats)(rtc::uid_t uid, int delay, int width, int height, int receivedBitrate, int decoderOutputFrameRate, int rendererOutputFrameRate, int packetLossRate, int rxStreamType, int totalFrozenTime, int frozenRate, int totalActiveTime);
		typedef void (*FUNC_OnRemoteAudioStats)(rtc::uid_t uid, int quality, int networkTransportDelay, int jitterBufferDelay, int audioLossRate, int numChannels, int receivedSampleRate, int receivedBitrate, int totalFrozenTime, int frozenRate, int totalActiveTime);
		...
		typedef void (*FUNC_OnFirstRemoteVideoFrame)(rtc::uid_t uid, int width, int height, int elapsed);
		...
		typedef void (*FUNC_OnRemoteVideoStateChanged)(rtc::uid_t uid, int state, int reason, int elapsed);
		...
		typedef void (*FUNC_OnRemoteSubscribeFallbackToAudioOnly)(rtc::uid_t uid, BOOL isFallbackOrRecover);
		...
		typedef void (*FUNC_OnLocalUserRegistered)(rtc::uid_t uid, const char* userAccount);
		typedef void (*FUNC_OnUserInfoUpdated)(rtc::uid_t uid, rtc::uid_t userUid, char* userAccount);
		typedef void (*FUNC_OnLocalAudioStateChanged)(int state, int error);
		typedef void (*FUNC_OnRemoteAudioStateChanged)(rtc::uid_t uid, int state, int reason, int elapsed);
		typedef void (*FUNC_OnStreamInjectedStatus)(const char* url, rtc::uid_t uid, int status);
		...
		public:
			...
			FUNC_OnRemoteSubscribeFallbackToAudioOnly onRemoteSubscribeFallbackToAudioOnly = nullptr;
			FUNC_OnLocalPublishFallbackToAudioOnly onLocalPublishFallbackToAudioOnly = nullptr;
		...
		public:
			...
			void
			onJoinChannelSuccess(const char* channel, rtc::uid_t uid, int elapsed) override;

			void
			onLeaveChannel(const rtc::RtcStats& stats) override;

			void
			onRejoinChannelSuccess(const char* channel, rtc::uid_t uid, int elapsed) override;

			void
			onUserJoined(rtc::uid_t uid, int elapsed) override;
			...
			void
			onUserOffline(rtc::uid_t uid, rtc::USER_OFFLINE_REASON_TYPE reason) override;

			void
			onUserMuteAudio(rtc::uid_t uid, bool muted) override;

			void
			onFirstRemoteVideoDecoded(rtc::uid_t uid, int width, int height, int elapsed) override;

			void
			onUserMuteVideo(rtc::uid_t uid, bool muted) override;
			...
			void
			onVideoSizeChanged(rtc::uid_t uid, int width, int height, int rotation) override;
			...
			void
			onAudioQuality(rtc::uid_t uid,
				int quality,
				unsigned short delay,
				unsigned short lost) override;

			void
			onRemoteVideoTransportStats(rtc::uid_t uid,
				unsigned short delay,
				unsigned short lost,
				unsigned short rxKBitRate) override;

			void
			onRemoteAudioTransportStats(rtc::uid_t uid,
				unsigned short delay,
				unsigned short lost,
				unsigned short rxKBitRate) override;

			void
			onStreamInjectedStatus(const char* url, rtc::uid_t uid, int status) override;
			...
			void
			onActiveSpeaker(rtc::uid_t uid) override;

			void
			onFirstRemoteAudioFrame(rtc::uid_t uid, int elapsed) override;
			...
			void
			onStreamMessageError(rtc::uid_t uid,
				int streamId,
				int code,
				int missed,
				int cached) override;
			...
			void
			onStreamMessage(rtc::uid_t uid, int streamId, const char* data, size_t length) override;
			...
			void
			onNetworkQuality(rtc::uid_t uid, int txQuality, int rxQuality) override;
			...
			void
			onFirstRemoteVideoFrame(rtc::uid_t uid, int width, int height, int elapsed) override;

			void
			onUserEnableVideo(rtc::uid_t uid, bool enabled) override;
			...
			void
			onRemoteVideoStateChanged(rtc::uid_t uid,
				rtc::REMOTE_VIDEO_STATE state,
				rtc::REMOTE_VIDEO_STATE_REASON reason,
				int elapsed) override;

			void
			onUserEnableLocalVideo(rtc::uid_t uid, bool enabled) override;

			void
			onLocalPublishFallbackToAudioOnly(bool isFallbackOrRecover) override;

			void
			onRemoteSubscribeFallbackToAudioOnly(rtc::uid_t uid, bool isFallbackOrRecover) override;
			...
			void
			onFirstRemoteAudioDecoded(rtc::uid_t uid, int elapsed) override;
			...
			void
			onLocalUserRegistered(rtc::uid_t uid, const char* userAccount) override;

			void
			onUserInfoUpdated(rtc::uid_t uid, const rtc::UserInfo& info) override;
			...
			void
			onRemoteAudioStateChanged(rtc::uid_t uid,
