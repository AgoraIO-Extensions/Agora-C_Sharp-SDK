...
{
    class CameraHelper : IDisposable
    {
        // camera image size.
        ...
        // Get image.
        // Immediately after starting, fails because image buffer is not prepared yet.
        ...
        public class PropertyItems
        {
            ...
            // <summary>Video Processing Amplifier properties.
            private Dictionary<DirectShow.VideoProcAmpProperty, Property> VideoProcAmp;

            // <summary>Get CameraControl Property. Check Available before use.
            public Property this[DirectShow.CameraControlProperty item] { get { return CameraControl[item]; } }

            // <summary>Get VideoProcAmp Property. Check Available before use.
        ...
        // Get Bitmap from Sample Grabber Current Buffer
