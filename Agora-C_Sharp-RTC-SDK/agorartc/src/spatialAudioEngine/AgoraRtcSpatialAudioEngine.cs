...
namespace agora.rtc
{
    ...
    public sealed class AgoraRtcCloudSpatialAudioEngine : IAgoraRtcCloudSpatialAudioEngine
    {
        ...
        public override int Initialize(SpatialAudioConfig config)
        {
            var param = new
            {
                config
        ...
        public override int SetRangeAudioMode(int rangeAudioMode)
        {
            var param = new
            {
                rangeAudioMode
    ...
    public sealed class AgoraRtcSpatialAudioEngine : IAgoraRtcSpatialAudioEngine
    {
        ...
        public override int UpdateRemotePosition(uint uid, float[] position)
        {
            var param = new
            {
                uid,
