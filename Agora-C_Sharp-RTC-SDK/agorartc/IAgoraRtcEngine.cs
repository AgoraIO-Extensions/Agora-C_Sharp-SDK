...
namespace agora.rtc
{
    ...
    public abstract class IRtcEngine
    {
         ...
         *  This method only takes effect when the channel profile is live interactive streaming ( SetChannelProfile when the profile parameter in set as CHANNEL_PROFILE_LIVE_BROADCASTING).
         * @param
         *  role: The user role. For details, see CLIENT_ROLE_TYPE .
         *  
         * @return
         * 0(ERR_OK): Success.
         *  < 0: Failure.
         ...
         * @param
         *  role: The user role in the interactive live streaming. See CLIENT_ROLE_TYPE .
         ...
         *  As of v3.6.2, when a user calls this method and then joins a channel successfully, the SDK triggers the OnProxyConnected callback to report the user ID, the proxy type connected, and the time elapsed from the user calling JoinChannel [1/2] until this callback is triggered.
         *  To disable the cloud proxy that has been set, call setCloudProxy(NONE_PROXY).
         *  To change the cloud proxy type that has been set, call setCloudProxy(NONE_PROXY) first, and then call setCloudProxy with the desired proxyType. Agora recommends that you call this method before joining the channel or after leaving the channel.
         ...
         *  When you use the Force TCP cloud proxy, note the following: An error occurs when calling StartAudioMixing [1/2] to play online music files in the HTTP protocol.
         ...
         * @return
         * 0: Success. < 0: Failure. -2 (ERR_INVALID_ARGUMENT): The parameter is invalid.
         *  -7(ERR_NOT_INITIALIZED): The SDK is not initialized.
         */
         ...
         * Deprecated:
         *  Deprecated as of v3.4.0. Please use GetAudioMixingDuration [2/2] instead. 
         ...
         *  Do not set the profile parameter of SetAudioProfile to AUDIO_PROFILE_SPEECH_STANDARD(1). Otherwise, the method does not take effect.
         *  This method works best with the human voice. Agora does not recommend using this method for audio containing music.
         ...
         * @param
         *  displayId: The display ID of the screen to be shared. Use this parameter to specify which screen you want to share. 
         ...
         *  regionRect: (Optional) Sets the relative location of the region to the screen. If you do not set this parameter, the SDK shares the whole screen.  If the specified region overruns the screen, the SDK shares only the region within it; if you set width or height as 0, the SDK shares the whole screen.
         * @return
         * 0: Success.
         *  < 0: Failure. ERR_INVALID_ARGUMENT: The argument is invalid.
         */
         ...
         *  You can find out from the OnVirtualBackgroundSourceEnabled callback whether the virtual background is successfully enabled or the cause of any errors. Before calling this method, ensure that you have integrated the dynamic library.
         *  Android: libagora_segmentation_extension.so
         *  iOS: AgoraVideoSegmentationExtension.xcframework
         *  macOS: AgoraVideoSegmentationExtension.framework Call this method after EnableVideo .
         ...
         *  After you call this method, the SDK triggers the OnUserSuperResolutionEnabled callback to report whether you have successfully enabled super resolution.
         ...
         *  On Android, the original resolution of the remote video must not exceed 640 × 360 pixels. On iOS, the original resolution of the remote video must not exceed 640 × 480 pixels. If you exceed these limitations, the SDK triggers the OnWarning callback and returns the corresponding warning codes:
         *  WARN_SUPER_RESOLUTION_STREAM_OVER_LIMITATION: 1610. The origin resolution of the remote video is beyond the range where the super resolution can be applied.
         ...
         *  
         *  type: The type of the audio recording device. See MEDIA_SOURCE_TYPE for details.
         *  frame: The external audio frame. See AudioFrame for details.
         * @return
         * 0: Success.
         *  < 0: Failure.
         */
         ...
         *  Call this method after joining a channel.
         * @param
         *  filePath: The file path: Android: The file path, including the filename extensions. To access an online file, Agora
         ...
         *  If you want to retry pushing streams after a failed push, make sure to call stopRtmpStream first, then call this method to retry pushing streams; otherwise, the SDK returns the same error code as the last failed push.
         * @param
         *  url: CDN streaming address. The format is RTMP or RTMPS. The character length cannot exceed 1024 bytes. Special characters such as Chinese characters are not supported.
         *  transcoding: Transcoding configurations for CDN live streaming. See LiveTranscoding .
         * @return
         * 0: Success. < 0: Failure.
         */
    ...
    public abstract class IAgoraRtcEngineEventHandler
    {
         ...
         *  x: The x coordinate (px) of the human face in the local
         ...
         *  left corner of the human face to the origin.
         *  y: The y coordinate (px) of the human face in the local
         *  video. Taking the top left corner of the captured video as the origin,
         *  the y coordinate represents the relative longitudinal displacement of
         *  the top left corner of the human face to the origin.
         *  width: The width (px) of the human
         *  face in the captured video.
         *  height: The height (px) of the human
         *  face in the captured video.
         *  
         ...
         *  numFaces: The number of faces detected. If the value is 0, it means that no human face
         *  is detected.
         */
