...
namespace Agora.Rtc
{
    ...
    public class LocalSpatialAudioEngineImpl
    {
        ...
        public int UpdateSelfPosition(float[] position, float[] axisForward, float[] axisRight, float[] axisUp)
        {
            ...
            param.Add("axisForward", axisForward);
            param.Add("axisRight", axisRight);
            param.Add("axisUp", axisUp);
        ...
        public int UpdatePlayerPositionInfo(int playerId, float[] position, float[] forward)
        {
            ...
            param.Add("positionInfo", positionInfo);
        ...
        public int SetZones(SpatialAudioZone[] zones, uint zoneCount)
        {
            if (!_initialized) return UNINITIALIZED;
            param.Clear();
            param.Add("zones", zones);
            param.Add("zoneCount", zoneCount);
        ...
        public int SetPlayerAttenuation(int playerId, double attenuation, bool forceSet)
        {
            ...
            param.Clear();
            param.Add("playerId", playerId);
            param.Add("attenuation", attenuation);
            param.Add("forceSet", forceSet);
