...
namespace Agora.Rtc
{
    ...
    using IrisVideoFrameBufferDelegateHandle = System.Int32;
#else
...
#region DllImport
        ...
        [DllImport(AgoraRtcLibName)]
        internal static extern string CallIrisApi(IrisRtcEnginePtr engine_ptr, string func_name,
        string @params, UInt32 paramLength, IntPtr bufferPtr, UInt32 bufferLength);


        //todo not use in down
        // IrisRtcRawData
        [DllImport(AgoraRtcLibName)]
