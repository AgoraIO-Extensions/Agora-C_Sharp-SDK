namespace Agora.Rtc
{
    ...
    public abstract class IAudioFrameObserver
    {
        ...
        /// To ensure that the data format of audio frame for playback is as expected, Agora recommends that you set the SetPlaybackAudioFrameParameters audio data format as follows: After calling to set the audio data format and to register the RegisterAudioFrameObserver audio frame observer object, the SDK calculates the sampling interval according to the parameters set in the methods, and triggers the callback according to the sampling interval OnPlaybackAudioFrame.
        /// </summary>
        ///
        ...
        /// To ensure that the data format of mixed captured and playback audio frame meets the expectations, Agora recommends that you set the SetMixedAudioFrameParameters data format as follows: After calling to set the audio data format and to register the RegisterAudioFrameObserver audio frame observer object, the SDK calculates the sampling interval according to the parameters set in the methods, and triggers the callback according to the sampling interval OnMixedAudioFrame.
        /// </summary>
        ///
        /// <param name="audio_Frame"> The raw audio data. See AudioFrame.</param>
        ///
