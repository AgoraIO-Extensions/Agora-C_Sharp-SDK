...
namespace Agora.Rtc
{
    ...
    public delegate void OnTranscodedStreamLayoutInfoHandler(RtcConnection connection, uint uid, int width, int height, int layoutCount, VideoLayout[] layoutlist);
