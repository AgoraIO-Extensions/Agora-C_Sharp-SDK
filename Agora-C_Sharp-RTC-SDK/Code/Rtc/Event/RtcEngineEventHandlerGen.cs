...
namespace Agora.Rtc {
    public partial class RtcEngineEventHandler : IRtcEngineEventHandler
    {
        ...
        public event Action<int, int> EventOnAudioRoutingChanged;

        public override void OnAudioRoutingChanged(int deviceType, int routing)
        { 
            if(EventOnAudioRoutingChanged == null) return;
            EventOnAudioRoutingChanged.Invoke(deviceType, routing);
        }
        ...
        public event Action<int> EventOnChannelMediaRelayEvent;
        ...
        public event Action<RtcConnection, LOCAL_VIDEO_STREAM_STATE, LOCAL_VIDEO_STREAM_ERROR> EventOnLocalVideoStateChanged;
