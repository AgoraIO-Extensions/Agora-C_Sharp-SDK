namespace Agora.Rtc
{
    ...
    /// </summary>
    ///
    public abstract class IMetadataObserverS : IMetadataObserverBase
    {
        ...
        public virtual bool OnReadyToSendMetadata(ref MetadataS metadataS, VIDEO_SOURCE_TYPE source_type)
        {
            return false;
        }
#endif
        ...
        ///
        public virtual void OnMetadataReceived(MetadataS metadataS)
        {
        }
    }
}