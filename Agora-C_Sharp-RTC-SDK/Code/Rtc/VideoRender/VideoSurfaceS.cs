...
namespace Agora.Rtc
{
    ...
    /// </summary>
    ///
    public class VideoSurfaceS : MonoBehaviour
    {
        ...
        [SerializeField] protected string UserAccount = "";
        ...
        protected TextureManagerS _textureManager;
            ...
            if (Enable)
            {
                if (_textureManager == null)
                {
                    ...
                    if (_TextureManagerGameObject == null)
                    {
                        ...
                        _textureManager = _TextureManagerGameObject.AddComponent<TextureManagerS>();
                        _textureManager.SetVideoStreamIdentity(UserAccount, ChannelId, SourceType, FrameType);
                        _textureManager.EnableVideoFrameWithIdentity();
                    }
                    else
                    {
                        _textureManager = _TextureManagerGameObject.GetComponent<TextureManagerS>();
                    }
                }
        ...
        void OnDestroy()
        {
            AgoraLog.Log(string.Format("VideoSurface RGBA channel: ${0}, userAccount:{1} destroy", ChannelId, UserAccount));
            DestroyTextureManager();
        }
        ...
        /// </summary>
        ///
        /// <param name="userAccount"> The ID of remote users, obtained through OnUserJoined . The default value is "", which means you can see the local video. </param>
        ///
        /// <param name="channelId"> The ID of the channel. </param>
        ///
        /// <param name="source_type"> The type of the video source. See VIDEO_SOURCE_TYPE. </param>
        ///
        public virtual void SetForUser(string userAccount = "", string channelId = "", VIDEO_SOURCE_TYPE source_type = VIDEO_SOURCE_TYPE.VIDEO_SOURCE_CAMERA_PRIMARY)
        {
            UserAccount = userAccount;
            ChannelId = userAccount == "" ? "" : channelId;
        ...
        {
            return "TextureManager" + "_" + UserAccount + "_" + ChannelId + "_" + SourceType.ToString() + "_" + FrameType.ToString();
        }
