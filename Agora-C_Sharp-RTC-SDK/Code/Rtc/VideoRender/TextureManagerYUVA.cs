...
namespace Agora.Rtc
{
    public class TextureManagerYUVA : TextureManagerYUV
    {
        ...
        internal override void ReFreshTexture()
        {
            ...
            _aTexture.LoadRawTextureData(tempVideoFrame.alphaBuffer);
            _texture.Apply();
            _uTexture.Apply();
            _vTexture.Apply();
            _aTexture.Apply();
        ...
        internal override void OnVideoFameEvent(ref IrisCVideoFrame videoFrame, ref IrisRtcVideoFrameConfig config, bool resize)
        {
            ...
            int aBufferLength = videoFrame.width * videoFrame.height;
            ...
            tempVideoFrame.alphaBuffer = new byte[aBufferLength];
            Marshal.Copy(videoFrame.alphaBuffer, tempVideoFrame.alphaBuffer, 0, aBufferLength);
