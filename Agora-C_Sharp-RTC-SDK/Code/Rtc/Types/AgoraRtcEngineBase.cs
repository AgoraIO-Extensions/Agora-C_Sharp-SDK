...
namespace Agora.Rtc
{
    ...
    public class LocalVideoStatsBase
    {
    ...
    public class RemoteAudioStatsBase
    {
        public int quality;
    ...
    public class RemoteVideoStatsBase
    {
        public int e2eDelay;
        ...
        public RemoteVideoStatsBase(int e2eDelay, int width, int height, int receivedBitrate, int decoderOutputFrameRate, int rendererOutputFrameRate, int frameLossRate, int packetLossRate, VIDEO_STREAM_TYPE rxStreamType, int totalFrozenTime, int frozenRate, int avSyncTimeMs, int totalActiveTime, int publishDuration, int mosValue, uint rxVideoBytes)
        {
    ...
    public class VideoCompositingLayoutBase
    {
        ...
        public VideoCompositingLayoutBase()
        {
            this.canvasWidth = 0;
            this.canvasHeight = 0;
        ...
        public VideoCompositingLayoutBase(int canvasWidth, int canvasHeight, string backgroundColor, string appData, int appDataLength)
        {
    ...
    public class RegionBase
    {
        ...
        public RegionBase(double x, double y, double width, double height, int zOrder, double alpha, RENDER_MODE_TYPE renderMode)
        {
            this.x = x;
            this.y = y;
            this.width = width;
    ...
    public class RtcEngineContextBase : IOptionalJsonParse
    {
        public string appId;
        ...
        public RtcEngineContextBase(string appId, ulong context, CHANNEL_PROFILE_TYPE channelProfile, string license, AUDIO_SCENARIO_TYPE audioScenario, AREA_CODE areaCode, LogConfig logConfig, Optional<THREAD_PRIORITY_TYPE> threadPriority, bool useExternalEglContext, bool domainLimit, bool autoRegisterAgoraExtensions)
        {
            this.appId = appId;
    ...
    public class MetadataBase
    {
        ...
        public MetadataBase(uint size, IntPtr buffer, long timeStampMs)
        {
            this.size = size;
            this.buffer = buffer;
    ...
    public class ExtensionInfoBase
    {
        public MEDIA_SOURCE_TYPE mediaSourceType;

        public string channelId;

        public ExtensionInfoBase()
        {
            this.mediaSourceType = MEDIA_SOURCE_TYPE.UNKNOWN_MEDIA_SOURCE;
            this.channelId = "";
        }

        public ExtensionInfoBase(MEDIA_SOURCE_TYPE mediaSourceType, string channelId)
        {
    ...
    #endregion terra IAgoraRtcEngineBase.h
}