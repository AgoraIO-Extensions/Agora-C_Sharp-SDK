...
this.mixPolicyForMixedTrack = mixPolicyForMixedTrack;
...
public DirectCdnStreamingStats(){
    ...
    public class DirectCdnStreamingMediaOptions: IOptionalJsonParse
    {
        ...
        public Optional<string> publishLoopbackDeviceName = new Optional<string>();

        public DirectCdnStreamingMediaOptions()
{
}

public DirectCdnStreamingMediaOptions(Optional<bool> publishCameraTrack,Optional<bool> publishMicrophoneTrack,Optional<bool> publishCustomAudioTrack,Optional<bool> publishCustomVideoTrack,Optional<bool> publishMediaPlayerAudioTrack,Optional<int> publishMediaPlayerId,Optional<uint> customVideoTrackId,Optional<bool> publishScreenTrack,Optional<bool> publishSecondaryScreenTrack,Optional<bool> publishThirdScreenTrack,Optional<bool> publishFourthScreenTrack,Optional<bool> publishLoopbackAudioTrack,Optional<string> publishLoopbackDeviceName)
{
this.publishCameraTrack = publishCameraTrack;
this.publishMicrophoneTrack = publishMicrophoneTrack;
this.publishCustomAudioTrack = publishCustomAudioTrack;
...
this.publishLoopbackDeviceName = publishLoopbackDeviceName;
}
