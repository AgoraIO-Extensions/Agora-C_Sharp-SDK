...
namespace Agora.Rtc
{
    ...
    public enum INTERFACE_ID_TYPE
    {
        ...
        AGORA_IID_MEDIA_ENGINE_S = 17,

        AGORA_IID_LOCAL_SPATIAL_AUDIO_S = 18,
    }
    ...
    public class EncodedVideoFrameInfoBase
    {
        public VIDEO_CODEC_TYPE codecType;
        ...
        public EncodedVideoFrameInfoBase()
        {
            this.codecType = VIDEO_CODEC_TYPE.VIDEO_CODEC_H264;
            this.width = 0;
            this.height = 0;
        ...
        public EncodedVideoFrameInfoBase(EncodedVideoFrameInfoBase rhs)
        {
        ...
        public EncodedVideoFrameInfoBase(VIDEO_CODEC_TYPE codecType, int width, int height, int framesPerSecond, VIDEO_FRAME_TYPE frameType, VIDEO_ORIENTATION rotation, int trackId, long captureTimeMs, long decodeTimeMs, VIDEO_STREAM_TYPE streamType)
        {
            this.codecType = codecType;
            this.width = width;
            this.height = height;
    ...
    public enum LOCAL_VIDEO_STREAM_ERROR
    {
        ...
        LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_PAUSED = 28,

        LOCAL_VIDEO_STREAM_ERROR_SCREEN_CAPTURE_RESUMED = 29,
    }
    ...
    public class VideoTrackInfo
    {
        ...
        public string ownerUserAccount;
        ...
        public VideoTrackInfo(bool isLocal, uint ownerUid, string ownerUserAccount, uint trackId, string channelId, VIDEO_STREAM_TYPE streamType, VIDEO_CODEC_TYPE codecType, bool encodedFrameOnly, VIDEO_SOURCE_TYPE sourceType, uint observationPosition)
        {
    ...
    public class AudioVolumeInfoBase
    {
        public uint volume;
        ...
        public AudioVolumeInfoBase(uint volume, uint vad, double voicePitch)
        {
            this.volume = volume;
            this.vad = vad;
    ...
    public class TranscodingUserBase
    {
        public int x;
        ...
        public TranscodingUserBase(int x, int y, int width, int height, int zOrder, double alpha, int audioChannel)
        {
            this.x = x;
            this.y = y;
            this.width = width;
    ...
    public class LiveTranscodingBase
    {
        public int width;
    ...
    public class TranscodingVideoStreamBase
    {
        public VIDEO_SOURCE_TYPE sourceType;
        ...
        public TranscodingVideoStreamBase()
        {
            this.sourceType = VIDEO_SOURCE_TYPE.VIDEO_SOURCE_CAMERA_PRIMARY;
            this.imageUrl = "";
            this.x = 0;
        ...
        public TranscodingVideoStreamBase(VIDEO_SOURCE_TYPE sourceType, string imageUrl, int mediaPlayerId, int x, int y, int width, int height, int zOrder, double alpha, bool mirror)
        {
            this.sourceType = sourceType;
    ...
    public class LocalTranscoderConfigurationBase
    {
        public VideoEncoderConfiguration videoOutputConfiguration;

        public bool syncWithPrimaryCamera;

        public LocalTranscoderConfigurationBase()
        {
            this.videoOutputConfiguration = new VideoEncoderConfiguration();
            this.syncWithPrimaryCamera = true;
        }

        public LocalTranscoderConfigurationBase(VideoEncoderConfiguration videoOutputConfiguration, bool syncWithPrimaryCamera)
        {
    ...
    public class VideoCanvasBase
    {
        ...
        public VideoCanvasBase(view_t v, RENDER_MODE_TYPE m, VIDEO_MIRROR_MODE_TYPE mt)
        {
            this.view = v;
            this.backgroundColor = 0x00000000;
            this.renderMode = m;
        ...
        public VideoCanvasBase(view_t v, RENDER_MODE_TYPE m, VIDEO_MIRROR_MODE_TYPE mt, uint subviewUid)
        {
            this.view = v;
            this.backgroundColor = 0x00000000;
            this.renderMode = m;
        ...
        public VideoCanvasBase(view_t view, uint backgroundColor, RENDER_MODE_TYPE renderMode, VIDEO_MIRROR_MODE_TYPE mirrorMode, VIDEO_VIEW_SETUP_MODE setupMode, VIDEO_SOURCE_TYPE sourceType, int mediaPlayerId, Rectangle cropArea, bool enableAlphaMask, VIDEO_MODULE_POSITION position, uint subviewUid)
        {
            this.view = view;
            this.backgroundColor = backgroundColor;
    ...
    public class ChannelMediaInfoBase
    {
        public string channelName;

        public string token;

        public ChannelMediaInfoBase()
        {
            this.channelName = "";
            this.token = "";
        }

        public ChannelMediaInfoBase(string c, string t)
        {
            this.channelName = c;
            this.token = t;
        }
    ...
    public class ChannelMediaRelayConfigurationBase
    {
        public int destCount;

        public ChannelMediaRelayConfigurationBase()
        {
            this.destCount = 0;
        }

        public ChannelMediaRelayConfigurationBase(int destCount)
        {
    ...
    public class RecorderStreamInfoBase
    {
        public string channelId;

        public RecorderStreamInfoBase()
        {
            this.channelId = "";
        }

        public RecorderStreamInfoBase(string channelId)
        {
            this.channelId = channelId;
        }
    ...
    #endregion terra AgoraCommonBase.h
}