...
namespace Agora.Rtc
{
    ...
    public partial class H265TranscoderImpl
    {
        ...
        private int CreateEventHandler()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IH265TRANSCODER_REGISTERTRANSCODEROBSERVER_e1ee996 failed: " + nRet);
            }
            arrayPtrHandle.Free();
            return nRet;
        }
        ...
        private int ReleaseEventHandler()
        {
            ...
            if (nRet != 0)
            {
                AgoraLog.LogError("IH265TRANSCODER_UNREGISTERTRANSCODEROBSERVER_e1ee996 failed: " + nRet);
            }
