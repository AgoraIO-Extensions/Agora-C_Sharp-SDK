...
/// </summary>
///
/// <param name ="profile">The audio profile, including the sampling rate, bitrate, encoding mode, and the number of channels. See AUDIO_PROFILE_TYPE .
///  </param>
///
/// <returns>
/// 0: Success. < 0: Failure.
...
///
/// <param name ="mode">The mode in which the video stream is sent. See SIMULCAST_STREAM_MODE .</param>
/// <param name ="streamConfig">The configuration of the low-quality video stream. See SimulcastStreamConfig .
///  </param>
///
/// <returns>
/// 0: Success.< 0: Failure.
...
/// </summary>
///
/// <param name ="filePath">The absolute path (including the filename extensions) of the recording file. For example: C:\music\audio.mp4. Ensure that the path for the recording file exists and is writable.
///  </param>
...
/// </summary>
///
/// <param name ="transcoding">The transcoding configuration for media push. See LiveTranscoding .
///  </param>
///
/// <returns>
/// 0: Success.< 0: Failure.
