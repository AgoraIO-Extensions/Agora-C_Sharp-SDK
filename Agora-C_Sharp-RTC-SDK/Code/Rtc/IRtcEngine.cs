...
namespace Agora.Rtc
{
    ...
    public abstract class IRtcEngine
    {
        ...
        ///
        /// If you need a more comprehensive solution for low-latency, high-concurrency, and scalable real-time messaging and status synchronization, it is recommended to use Signaling. You can call this method to create a data stream and improve the reliability and ordering of data transmission.
        /// </summary>
        ///
        ...
        ///
        /// If you need a more comprehensive solution for low-latency, high-concurrency, and scalable real-time messaging and status synchronization, it is recommended to use Signaling. After calling CreateDataStream [2/2], you can call this method to send data stream messages to all users in the channel. The SDK has the following restrictions on this method:
