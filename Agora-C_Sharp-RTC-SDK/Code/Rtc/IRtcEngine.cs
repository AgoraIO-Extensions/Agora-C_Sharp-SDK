...
namespace Agora.Rtc
{
    ...
    public abstract class IRtcEngine : IRtcEngineBase
    {
        ...
        public abstract ILocalSpatialAudioEngine GetLocalSpatialAudioEngine();
         ...
         int SendMetadata(Metadata metadata, VIDEO_SOURCE_TYPE source_type);
#endif
        ...
        public abstract int GetExtensionProperty(string provider, string extension, ExtensionInfo extensionInfo, string key, string value, int buf_len);
