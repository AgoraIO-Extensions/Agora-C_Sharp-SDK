...
namespace Agora.Rtc {
 ...
 public abstract int SetLocalVideoDataSourcePosition(VIDEO_MODULE_POSITION position); 
        ...
        public abstract int PushAudioFrame (IAudioFrameObserver::AudioFrame* frame, uint trackId = 0);

        public abstract int PullAudioFrame (IAudioFrameObserver::AudioFrame* frame);
