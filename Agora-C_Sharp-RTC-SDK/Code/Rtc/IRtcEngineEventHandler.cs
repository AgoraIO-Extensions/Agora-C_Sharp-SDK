...
namespace Agora.Rtc
{
    ...
    public abstract class IRtcEngineEventHandler
    {
        ...
        ///
        /// <param name="totalVolume"> The volume of the speaker. The value range is [0,255].
        ///  In the callback for the local user, totalVolume is the volume of the local user who sends a stream. In the callback for remote users, totalVolume is the sum of the volume of all remote users (up to three) whose instantaneous volume is the highest.</param>
        ///
        ...
        ///
        /// <param name="errCode"> The message that confirms success or gives the reason why the snapshot is not successfully taken:
        ///  0: Success.
        ///  < 0: Failure:
        ...
        ///  -3: Calling the TakeSnapshot method too frequently.</param>
        ///
