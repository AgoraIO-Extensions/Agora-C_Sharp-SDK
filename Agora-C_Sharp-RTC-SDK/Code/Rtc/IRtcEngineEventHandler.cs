...
namespace Agora.Rtc {
    public abstract class IRtcEngineEventHandler 
    {
        ...
        [Obsolete("This callback is deprecated. Use onAudioRoutingChanged with 2 params instead.")]
        ...
        [Obsolete("v4.2.0. This callback is not recommended and will be removed in future releases.")]
