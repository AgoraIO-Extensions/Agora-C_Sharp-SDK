...
namespace Agora.Rtc
{
    ...
    public abstract class IMediaPlayerCustomDataProvider
    {
        ...
        ///
        /// <param name="whence"> An input parameter. The starting point. You can set it as one of the following values:0: The starting point is the head of the data, and the actual data offset after seeking isoffset.1: The starting point is the current position, and the actual data offset after seeking is the current position plusoffset.2: The starting point is the end of the data, and the actual data offset after seeking is the whole data length plusoffset.65536: Do not perform position seeking, return the file size. Agora recommends that you use this parameter value when playing pure audio files such as MP3 and WAV.</param>
        ///
        /// <returns>
        /// Whenwhence is65536, the media file size is returned.When whence is0,1, or2, the actual data offset after the seeking is returned.-1: Seeking failed.
        /// </returns>
        ///
        ...
        /// </summary>
        ///
        /// <param name="bufferPtr"> An input parameter. Data buffer (bytes). Write thebufferSize data reported by the SDK into this parameter.</param>
        ///
