...
namespace Agora.Rtm.Internal
{
    ...
    internal class RtmStorageImpl
    {
        ...
        public int SetChannelMetadata(string channelName, RTM_CHANNEL_TYPE channelType, RtmMetadata data, MetadataOptions options, string lockName, ref UInt64 requestId)
        {
            ...
            var nRet = AgoraRtmNative.CallIrisApiWithArgs(_irisApiRtmEngine, AgoraApiType.FUNC_RTMSTORAGE_SETCHANNELMETADATA,
        ...
        public int UpdateChannelMetadata(string channelName, RTM_CHANNEL_TYPE channelType, RtmMetadata data, MetadataOptions options, string lockName, ref UInt64 requestId)
        {
            ...
            var nRet = AgoraRtmNative.CallIrisApiWithArgs(_irisApiRtmEngine, AgoraApiType.FUNC_RTMSTORAGE_UPDATECHANNELMETADATA,
                json, (UInt32)json.Length,
                IntPtr.Zero, 0,
                ref _apiParam);
        ...
        public int RemoveChannelMetadata(string channelName, RTM_CHANNEL_TYPE channelType, RtmMetadata data, MetadataOptions options, string lockName, ref UInt64 requestId)
        {
            ...
            var nRet = AgoraRtmNative.CallIrisApiWithArgs(_irisApiRtmEngine, AgoraApiType.FUNC_RTMSTORAGE_REMOVECHANNELMETADATA,
                json, (UInt32)json.Length,
                IntPtr.Zero, 0,
                ref _apiParam);
        ...
        public int GetChannelMetadata(string channelName, RTM_CHANNEL_TYPE channelType, ref UInt64 requestId)
        {
            ...
            var nRet = AgoraRtmNative.CallIrisApiWithArgs(_irisApiRtmEngine, AgoraApiType.FUNC_RTMSTORAGE_GETCHANNELMETADATA,
                json, (UInt32)json.Length,
                IntPtr.Zero, 0,
                ref _apiParam);
        ...
        public int SetUserMetadata(string userId, RtmMetadata data, MetadataOptions options, ref UInt64 requestId)
        {
            ...
            var nRet = AgoraRtmNative.CallIrisApiWithArgs(_irisApiRtmEngine, AgoraApiType.FUNC_RTMSTORAGE_SETUSERMETADATA,
                json, (UInt32)json.Length,
                IntPtr.Zero, 0,
                ref _apiParam);
        ...
        public int UpdateUserMetadata(string userId, RtmMetadata data, MetadataOptions options, ref UInt64 requestId)
        {
            ...
            var nRet = AgoraRtmNative.CallIrisApiWithArgs(_irisApiRtmEngine, AgoraApiType.FUNC_RTMSTORAGE_UPDATEUSERMETADATA,
                json, (UInt32)json.Length,
                IntPtr.Zero, 0,
                ref _apiParam);
        ...
        public int RemoveUserMetadata(string userId, RtmMetadata data, MetadataOptions options, ref UInt64 requestId)
        {
            ...
            var nRet = AgoraRtmNative.CallIrisApiWithArgs(_irisApiRtmEngine, AgoraApiType.FUNC_RTMSTORAGE_REMOVEUSERMETADATA,
                json, (UInt32)json.Length,
                IntPtr.Zero, 0,
                ref _apiParam);
        ...
        public int GetUserMetadata(string userId, ref UInt64 requestId)
        {
            ...
            var nRet = AgoraRtmNative.CallIrisApiWithArgs(_irisApiRtmEngine, AgoraApiType.FUNC_RTMSTORAGE_GETUSERMETADATA,
                json, (UInt32)json.Length,
                IntPtr.Zero, 0,
                ref _apiParam);
        ...
        public int SubscribeUserMetadata(string userId, ref UInt64 requestId)
        {
            ...
            var nRet = AgoraRtmNative.CallIrisApiWithArgs(_irisApiRtmEngine, AgoraApiType.FUNC_RTMSTORAGE_SUBSCRIBEUSERMETADATA,
                json, (UInt32)json.Length,
                IntPtr.Zero, 0,
                ref _apiParam);
