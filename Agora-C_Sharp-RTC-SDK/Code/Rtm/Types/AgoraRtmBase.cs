...
namespace Agora.Rtm
{
    ...
    public enum RTM_ERROR_CODE
    {
        ...
        RTM_ERR_PRE_SUBSCRIBE_WITH_INVALID_ARGUMENT = 10016,
        ...
        RTM_ERR_PRESENCE_CHANNEL_COUNT_OVERFLOW = 10310,

        RTM_ERR_PRESENCE_CHANNEL_NOT_EXIST = 10311,
    };
    ...
    public enum RTM_PRESENCE_EVENT_TYPE
    {
        ...
        RTM_PRESENCE_EVENT_TYPE_ERROR_OUT_OF_SERVICE = 6,
    };
