...
namespace Agora.Rtc
{
    ...
    public abstract class IRtcEngine
    {
        ...
        /// If you want to create a new IRtcEngine instance after destroying the current one, ensure that you wait till the Dispose method execution to complete.
        /// </summary>
        ///
        /// <param name="sync"> true: Synchronous call. Agora suggests calling this method in a sub-thread to avoid congestion in the main thread because the synchronous call and the app cannot move on to another task until the resources used by IRtcEngine are released. Besides, you cannot call Dispose in any method or callback of the SDK. Otherwise, the SDK cannot release the resources until the callbacks return results, which may result in a deadlock. The SDK automatically detects the deadlock and converts this method into an asynchronous call, causing the test to take additional time.
        ///  false: Asynchronous call. The app can move on to another task, no matter the resources used by IRtcEngine are released or not. Do not immediately uninstall the SDK's dynamic library after the call; otherwise, it may cause a crash due to the SDK clean-up thread not quitting.</param>
        ///
        ...
        /// After joining the channel, you must call this method or LeaveChannel [1/2] 
        ...
        /// -17(ERR_JOIN_CHANNEL_REJECTED): The request to join the channel is rejected. Since the SDK only supports users to join a channel at the same time IRtcEngine , this error code IRtcEngine will be returned when the user IRtcEngine who has joined the channel calls the join channel method in the class again with a valid channel name.
        /// </returns>
        ///
        ...
        /// </summary>
        ///
        /// <param name="mute"> true: Mute the recording signal.
        ///  false: (Default) Do not mute the recording signal.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="volume"> Audio mixing volume. The value ranges between 0 and 100. The default value is 100, the original volume.</param>
        ///
        ...
        /// Once the local audio function is disabled or re-enabled, the SDK triggers the OnLocalAudioStateChanged callback, which reports LOCAL_AUDIO_STREAM_STATE_STOPPED (0) or LOCAL_AUDIO_STREAM_STATE_RECORDING (1). This method is different from the MuteLocalAudioStream method:
        ...
        /// </summary>
        ///
        /// <param name="enabled">  true: (Default) Re-enable the local audio function, that is, to start the local audio capturing device (for example, the microphone).
        ///  false: Disable the local audio function, that is, to stop local audio capturing. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        ///  false: (Default) Resumes publishing the local audio stream. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="mute"> Whether to stop subscribing to the audio streams of all remote users by default.
        ...
        ///
        /// <param name="mute"> Whether to stop subscribing to the audio stream of the specified user. true: Unsubscribe from the specified user's audio stream.
        ///  false: (Default) Subscribes to the specified user's audio stream. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// The local preview enables the mirror mode by default.
        /// After the local video preview is enabled, if you call LeaveChannel [1/2] StopPreview [2/2] to disable it.
        ...
        ///
        /// <param name="mirrorMode"> The rendering mode of the local video view. See VIDEO_MIRROR_MODE_TYPE .
        ///  If you use a front camera, the SDK enables the mirror mode by default; if you use a rear camera, the SDK disables the mirror mode by default. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="mute"> Whether to stop publishing the local video stream.
        ///  true: Stop publishing the local video stream.
        ///  false: (Default) Publish the local video stream. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// <param name="uid"> The user ID of the specified user.</param>
        ///
        /// <param name="mute"> Whether to subscribe to the specified remote user's video stream.
        ///  true: Unsubscribe from the specified user's video stream.
        ///  false: (Default) Subscribes to the specified user's video stream. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable the local video capture. true: (Default) Enable the local video capture.
        ///  false: Disables the local video capture. Once the local video is disabled, the remote users can no longer receive the video stream of this user, while this user can still receive the video streams of the other remote users. falseWhen set to , this method does not require a local camera.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// <param name="mute"> Whether to stop subscribing to the audio streams of all remote users by default.
        ///  true: Stop subscribing to the audio streams of all remote users by default.
        ///  false: (Default) Resume subscribing to the audio streams of all remote users by default. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// The method is asynchronous, and the SDK has not taken the snapshot when the method call returns. Call this method after joining a channel.
        ...
        /// </summary>
        ///
        /// <param name="config"> The configuration of the snaptshot, see .</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        ///
        /// <param name="enabled"> Whether to enable the image enhancement function:
        ///  true: Enable the image enhancement function.
        ///  false: (Default) Disable the image enhancement function.</param>
        ///
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable virtual background:
        ///  true: Enable the image enhancement function.
        ///  false: Disable virtual background.</param>
        ///
        ...
        ///
        /// <param name="enable"> Whether to enable super resolution for the remote user’s video:
        ///  true: Enable the image enhancement function.
        ///  false: Disable virtual background.</param>
        ///
        /// <returns>
        ...
        /// The distance between the human face and the screen. This method needs to be called after the camera is started (for example, by calling StartPreview JoinChannel [2/2]).
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable face detection for the local user:
        ///  true: Enable face detection.
        ///  false: (Default) Disable face detection.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// This method enables or disables in-ear monitoring. This method is for Android and iOS only.
        /// Users must use wired earphones to hear their own voices.
        /// You can call this method either before or after joining a channel.
        /// </summary>
        ///
        /// <param name="enabled"> Enables in-ear monitoring.
        ///  true: Enables in-ear monitoring.
        ///  false: (Default) Disables in-ear monitoring.</param>
        ///
        ...
        /// This method mixes the specified local or online audio file with the audio from the microphone, or replaces the microphone's audio with the specified local or remote audio file. A successful method call triggers the OnAudioMixingStateChanged (AUDIO_MIXING_STATE_PLAYING) callback. When the audio mixing file playback finishes, the SDK triggers the OnAudioMixingStateChanged (AUDIO_MIXING_STATE_STOPPED) callback on the local client. You can call this method either before or after joining a channel. If you need to call StartAudioMixing [1/2] multiple times, ensure that the call interval is longer than 500 ms.
        ...
        ///
        /// <param name="loopback"> Whether to play music files only on the local client:
        ///  true: Only play music files on the local client so that only the local user can hear the music.
        ///  false: Publish music files to remote clients so that both the local user and remote users can hear the music. </param>
        ///
        /// <param name="replace"> Whether to replace the audio captured by the microphone with a music file:
        ///  true: Replace the audio captured by the microphone with a music file. Users can only hear the music.
        ///  false: Do not replace the audio captured by the microphone with a music file. Users can hear both music and audio captured by the microphone. </param>
        ///
        ...
        ///  -1: Play the music file in an infinite loop. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// To use this method, ensure that the Android device is v4.2 or later, and the API version is v16 or later.
        /// If you need to play an online music file, Agora does not recommend using the redirected URL address. Some Android devices may fail to open a redirected URL address.
        /// If you call this method on an emulator, ensure that the music file is in the /sdcard/ directory and the format is MP3. For the audio file formats supported by this method, see What formats of audio files the Agora RTC SDK support.
        /// You can call this method either before or after joining a channel. If you need to call StartAudioMixing [2/2] multiple times, ensure that the call interval is longer than 500 ms.
        /// If the local music file does not exist, the SDK does not support the file format, or the the SDK cannot access the music file URL, the SDK reports (701).
        /// </summary>
        ///
        ...
        /// This method retrieves the playback position (ms) of the current music file. You need to call this method after calling StartAudioMixing [2/2] and receiving the OnAudioMixingStateChanged(AUDIO_MIXING_STATE_PLAYING) callback.
        ...
        /// To ensure smooth communication, limit the size of the audio effect file. Wer ecommend using this method to preload the audio effect before calling JoinChannel [2/2]. This method does not support online audio effect files.
        ...
        ///
        /// <param name="filePath"> Windows: The absolute path or URL address (including the suffixes of the filename) of the audio effect file. For example: C:\music\audio.mp4. Supported audio formats include MP3, AAC, M4A, MP4, WAV, and 3GP. See supported audio formats.
        ///  If you have loaded the audio effect into memory via PreloadEffect , make sure this parameter is the same as the filePath set in PreloadEffect. </param>
        ///
        ...
        ///
        /// <param name="pan"> The spatial position of the audio effect. The value ranges between -1.0 and 1.0, where:
        ///  -1.0: The audio effect displays to the left.
        ///  0.0: The audio effect displays ahead.
        ///  1.0: The audio effect displays to the right. </param>
        ///
        ...
        ///
        /// <param name="publish"> Whether to publish the audio effect to the remote users.
        ///  true: Publish the audio effect to the remote users. Both the local user and remote users can hear the audio effect.
        ///  false: Do not publish the audio effect to the remote users. Only the local user can hear the audio effect. </param>
        ///
        /// <param name="startPos"> The playback position (ms) of the audio effect file.</param>
        ///
        /// <returns>
        ...
        /// For better voice effects, Agora recommends that you call SetAudioProfile [1/2] and set scenario to AUDIO_SCENARIO_GAME_STREAMING(3) and profile to AUDIO_PROFILE_MUSIC_HIGH_QUALITY(4) or AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO(5) before calling this method. You can call this method either before or after joining a channel.
        ...
        /// To get better audio effect quality, Agora recommends calling and setting scenario in SetAudioProfile [1/2] as AUDIO_SCENARIO_GAME_STREAMING(3) before calling this method. You can call this method either before or after joining a channel.
        ...
        /// This method works best with the human voice. Agora does not recommend using this method for audio containing music.
        /// If you call SetAudioEffectPreset, you need to set preset as ROOM_ACOUSTICS_3D_VOICE or PITCH_CORRECTION, and do not call SetAudioEffectParameters ; otherwise, SetAudioEffectPreset is overridden.
        ...
        /// To achieve better audio effect quality, Agora recommends that you call SetAudioProfile [1/2] and set the profile to AUDIO_PROFILE_MUSIC_HIGH_QUALITY(4) or AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO(5) and scenario to AUDIO_SCENARIO_GAME_STREAMING(3) before calling this method. You can call this method either before or after joining a channel.
        /// Do not set the profile parameter in SetAudioProfile [1/2] to AUDIO_PROFILE_SPEECH_STANDARD(1)
        /// This method works best with the human voice. Agora does not recommend using this method for audio containing music.
        ...
        /// </summary>
        ///
        /// <param name="preset"> The options for SDK preset audio effects:
        ...
        ///
        /// <param name="param1"> If you set preset to ROOM_ACOUSTICS_3D_VOICE , param1 indicates the cycle period of the 3D voice effect. The value range is [1,60], in seconds. The default value is 10, indicating that the voice moves around you every 10 seconds.
        ///  If you set preset to PITCH_CORRECTION , param1 indicates the basic mode of the pitch correction effect:
        ///  1: (Default) Natural major scale.
        ///  2: Natural minor scale.
        ///  3: Japanese pentatonic scale. </param>
        ///
        ...
        /// </summary>
        ///
        /// <param name="preset"> The option for the preset audio effect:
        ///  SINGING_BEAUTIFIER: The singing beautifier effect.</param>
        ///
        /// <param name="param1"> The gender characteristics options for the singing voice:
        ///  1: A male-sounding voice.
        ///  2: A female-sounding voice.</param>
        ///
        /// <param name="param2"> The reverberation effect options for the singing voice:
        ///  1: The reverberation effect sounds like singing in a small room.
        ///  2: The reverberation effect sounds like singing in a large room.
        ///  3: The reverberation effect sounds like singing in a hall.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        ///
        /// <param name="includeScreen"> Whether the SDK returns the screen information in addition to the window information:
        ///  true: The SDK returns the screen and window information.
        ///  false: The SDK returns the window information only.</param>
        ///
        /// <returns>
        ...
        /// Call this method after joining a channel, and then call UpdateChannelMediaOptions and set publishScreenTrack or publishSecondaryScreenTrack to true to start screen sharing. This method shares a screen or part of the screen. You need to specify the ID of the screen to be shared in this method. This method applies to macOS only.
        /// </summary>
        ///
        /// <param name="displayId"> The display ID of the screen to be shared. This parameter specifies which screen you want to share.</param>
        ///
        ...
        /// There are two ways to start screen sharing, you can choose one according to the actual needs:
        /// Call this method before joining a channel, and then call JoinChannel [2/2] to join a channel and set publishScreenTrack or publishSecondaryScreenTrack to true to start screen sharing.
        /// Call this method after joining a channel, and then call UpdateChannelMediaOptions and set publishScreenTrack or publishSecondaryScreenTrack to true to start screen sharing. This method shares a screen or part of the screen. You need to specify the area of the screen to be shared.
        /// This method applies to Windows only.
        /// </summary>
        ///
        ...
        /// </summary>
        ///
        /// <param name="mediaProjectionPermissionResultData"> Pass in the data parameter of the onActivity callback.</param>
        ///
        /// <param name="captureParams"> The screen sharing encoding parameters. The default video dimension is 1920 x 1080, that is, 2,073,600 pixels. Agora uses the value of this parameter to calculate the charges. See ScreenCaptureParameters .</param>
        ///
        /// <returns>
        ...
        /// If you have enabledthe local video preview by calling the StartPreview visibleInPreview member to set whether or not the watermark is visible in the preview.
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable built-in encryption:
        ///  true: Enable the built-in encryption.
        ///  false: Disable the built-in encryption. </param>
        ///
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable stereo panning for remote users:
        ///  true: Enable stereo panning.
        ///  false: Disable stereo panning.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="url"> The Media Push URL in the RTMP or RTMPS format. The maximum length of this parameter is 1024 bytes. The URL address must not contain special characters, such as Chinese language characters.</param>
        ///
        /// <param name="transcodingEnabled"> Whether to enable transcoding. Transcoding in a CDN live streaming converts the audio and video streams before pushing them to the CDN server. It applies to scenarios where a channel has multiple broadcasters and composite layout is needed.
        ///  true: Enable transcoding.
        ///  false: Disable transcoding. If you set this parameter as true, ensurethat you call the SetLiveTranscoding method before calling this method. </param>
        ///
        /// <returns>
        /// 0: Success. &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="url"> The media push URL in the RTMP or RTMPS format. The maximum length of this parameter is 1024 bytes. The media push URL must not contain special characters, such as Chinese characters.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="transcoding"> The transcoding configurations for Media Push. See LiveTranscoding.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// Call the method after successfully calling the StartChannelMediaRelay method and receiving OnChannelMediaRelayStateChanged (RELAY_STATE_RUNNING, RELAY_OK); otherwise, the method call fails.
        /// </summary>
        ///
        ...
        ///
        /// <param name="wrap"> Whether to use the placeholder. Agora recommends using the default value.
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable the external audio source:
        ///  true: Enable the external audio source.
        ///  false: (Default) Disable the external audio source. </param>
        ///
        ...
        ///
        /// <param name="localPlayback"> Whether to play the external audio source:
        ///  true: Play the external audio source.
        ///  false: (Default) Do not play the external source. </param>
        ///
        /// <param name="publish"> Whether to publish audio to the remote users:
        ///  true: (Default) Publish audio to the remote users.
        ///  false: Do not publish audio to the remote users </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="observer"> The observer object instance. See IAudioFrameObserver . Set the value as NULL to release the observer object. Agora recommends releasing the observer object after receiving the OnLeaveChannel callback.</param>
        ///
        ...
        /// </summary>
        ///
        /// <param name="sampleRate"> OnPlaybackAudioFrameThe sample rate returned in the callback, which can be set as 8000, 16000, 32000, 44100, or 48000 Hz.</param>
        ///
        ...
        /// Call this method after joining a channel.
        /// This method and StartAudioRecording [3/3] both set the audio content and audio quality. Agora recommends not using this method and StartAudioRecording [3/3] together; otherwise, only the method called later will take effect.
        /// </summary>
        ///
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to use the external video source:
        ///  true: Use the external video source. The SDK prepares to accept the external video frame.
        ///  false: (Default) Do not use the external video source.</param>
        ///
        /// <param name="useTexture"> Whether to use the external video frame in the Texture format.
        ///  true: Use the external video frame in the Texture format.
        ///  false: (Default) Do not use the external video frame in the Texture format.</param>
        ///
        ...
        /// </summary>
        ///
        /// <param name="videoFrameObserver"> The observer object instance. To release the instance, set the value as NULL. See IVideoFrameObserver .</param>
        ///
        ...
        /// </summary>
        ///
        /// <param name="videoEncodedImageReceiver"> The receiver object. See IVideoEncodedImageReceiver .</param>
        ///
        /// <param name="mode"> The video data callback mode. See OBSERVER_MODE .</param>
        ///
        ...
        /// <param name="provider"> The name of the extension provider.</param>
        ///
        /// <param name="enable"> Whether to enable the extension:
        ///  true: Enable the extension.
        ///  false: Disable the extension. </param>
        ///
        ...
        ///
        /// <param name="type"> The metadata type. The SDK currently only supports VIDEO_METADATA.  METADATA_TYPE </param>
        ///
        ...
        /// Deprecated:
        /// This method is deprecated as of v2.9.1. It has a fixed recording sample rate of 32 kHz. Use StartAudioRecording [3/3] instead. The Agora SDK allows recording during a call. This method records the audio of all the users in the channel and generates an audio recording file. Supported formats of the recording file are as follows:
        /// .wav: Large file size with high fidelity.
        /// .aac: Small file size with low fidelity. Ensure that the directory for the recording file exists and is writable. This method should be called after the method. The recording automatically stops when you call the LeaveChannel [1/2] JoinChannel [1/2]
        /// </summary>
        ///
        ...
        /// Stops the audio recording on the client.
        /// Deprecated:
        /// This method is deprecated. Use StartAudioRecording [3/3] instead. The Agora SDK allows recording during a call. After successfully calling this method, you can record the audio of all the users in the channel and get an audio recording file. Supported formats of the recording file are as follows:
        /// .wav: Large file size with high fidelity.
        ...
        /// This method needs to be called after the camera is started (for example, by calling StartPreview JoinChannel [2/2] ). This method is for Android and iOS only.
        /// </summary>
        ///
        /// <returns>
        /// 0: Success.
        ...
        /// This method needs to be called after the camera is started (for example, by calling StartPreview JoinChannel [2/2] ). After a successful method call, the SDK triggers the OnCameraFocusAreaChanged callback.
        /// This method is for Android and iOS only.
        /// </summary>
        ///
        ...
        /// </summary>
        ///
        /// <param name="isOn"> Whether to turn on the camera flash:
        ///  true: Turn on the flash.
        ///  false: (Default) Turn off the flash. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable face autofocus:
        ///  true: Enable face autofocus.
        ///  false: Disable face autofocus. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// This method needs to be called after the camera is started (for example, by calling StartPreview JoinChannel [2/2] ).
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable auto exposure: true: Enable auto exposure.
        ///  false: Disable auto exposure. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="defaultToSpeaker"> Whether to set the speakerphone as the default audio route:
        ///  true: Set the speakerphone as the default audio route.
        ///  false: Set the earpiece as the default audio route.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="speakerOn"> Whether to set the speakerphone as the default audio route:
        ///  true: Set the speakerphone as the audio route temporarily.
        ///  false: Do not set the speakerphone as the audio route. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        ///  > 0: Time interval (ms) between two consecutive volume indications. You need to set this parameter to an integer multiple of 200. If the value is lower than 200, the SDK automatically adjusts the value to 200.</param>
        ///
        ...
        ///
        /// <param name="reportVad"> true: Enable the voice activity detection of the local user. Once it is enabled,the vad parameter of the OnAudioVolumeIndication callback reports the voice activity status of the local user.
        ///  false: (Default) Disable the voice activity detection of the local user. Once it is disabled, the vad parameter of the OnAudioVolumeIndication callbackdoes not report the voice activity status of the local user, except for the scenario where the engine automatically detects the voice activity of the local user.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// Each user can create up to five data streams during the lifecycle of IRtcEngine . Call this method after joining a channel.
        ...
        ///
        /// <param name="reliable"> Whether or not the data stream is reliable:
        ...
        ///  false: There is no guarantee that the recipients receive the data stream within five seconds and no error message is reported for any delay or missing data stream. </param>
        ///
        /// <param name="ordered"> Whether or not the recipients receive the data stream in the sent order:
        ///  true: The recipients receive the data in the sent order.
        ///  false: The recipients do not receive the data in the sent order. </param>
        ///
        /// <returns>
        ...
        /// A failed method call triggers the OnStreamMessageError callback on the remote client. Ensure that you call CreateDataStream [2/2] to create a data channel before calling this method.
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable loopback audio capture.
        ///  true: Enable loopback audio capture.
        ///  false: (Default) Disable loopback audio capture.</param>
        ///
        ...
        /// </summary>
        ///
        /// <param name="proxyType"> The type of the cloud proxy. See CLOUD_PROXY_TYPE .
        ///  This parameter is mandatory. The SDK reports an error if you do not pass in a value.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable the spatial audio effect:
        ///  true: Enable the spatial sound effect.
        ///  false: Disable the spatial sound effect.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="url"> The URL address to be added to the ongoing streaming. Valid protocols are RTMP, HLS, and HTTP-FLV. Supported audio codec type: AAC.
        ///  Supported video codec type: H264 (AVC). </param>
        ///
        /// <param name="config"> The configuration information for the added video stream. See InjectStreamConfig .</param>
        ///
        /// <returns>
        /// 0: Success.
        ...
        /// </summary>
        ///
        /// <param name="url"> The URL address of the injected stream to be removed.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// publishCustomVideoTrack is set as false (Default) If you want to push external audio and video streams, ensure the following: publishCustomAudioTrack is set as true and call the PushAudioFrame method
        ...
        ///
        /// <summary>
        /// Pushes an external video stream to the SDK.
        /// </summary>
        ///
        /// <param name="frame"> The external video data. For details, see ExternalVideoFrame </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        ///
        /// <returns>
        /// The current connection state.  CONNECTION_STATE_TYPE
        /// </returns>
        ///
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Whether to enable interoperability with the Agora Web SDK.
        ///  true: Enable interoperability.
        ///  false: (Default) Disable interoperability.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="restriction"> The operation permissions of the SDK on the audio session, see AUDIO_SESSION_OPERATION_RESTRICTION . This parameter is Bit Mask, and each Bit corresponds to a permission.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="deviceInfo"> Input and output parameter. A DeviceInfo object that identifies the audio device information.
        ///  Input value: A DeviceInfo object.
        ///  Output value: A DeviceInfo object containing audio device information.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="option"> 订阅音视频流的回退选项。 默认值为 STREAM_FALLBACK_OPTION_VIDEO_STREAM_LOW(1)。 See STREAM_FALLBACK_OPTIONS .</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        ///
        /// <summary>
        /// Turns custom echo cancellation on/off.
        ...
        /// </summary>
        ///
        /// <param name="enabled"> Set whether to enable custom echo cancellation:
        ///  true: Enable custom echo cancellation.
        ///  false: Disable custom echo cancellation.</param>
        ///
        /// <param name="audioSourceDelay"> Sets the time (in milliseconds) between pushing audio frames and publishing audio frames. The value range is [0, 100].
        ///  To call , make sure this parameter is set to 0.
        ///  To call or process the audio frame captured by the sound card, please make sure that this parameter is an integer multiple of 10.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
    ...
    public abstract class IRtcEngineEx : IRtcEngine
    {
        ...
        ///
        /// <param name="mute"> Whether to stop receiving the audio stream of the specified user: true: Stop receiving the audio stream of the specified user.
        ///  false: (Default) Resume receiving the audio stream of the specified user.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// <param name="uid"> The user ID of the remote user.</param>
        ///
        /// <param name="mute"> Whether to stop receiving the video stream of the specified user:
        ///  true: Stop receiving the video stream of the specified user.
        ///  false: (Default) Resume receiving the video stream of the specified user. </param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// Creates a data stream.
        /// Deprecated:
        /// This method is deprecated. This method is deprecated. Use CreateDataStreamEx [2/2] instead. You can call this method to create a data stream and improve the reliability and ordering of data transmission. Ensure that you set the same value for reliable and ordered.
        ...
        /// <param name="streamId"> Output parameter. Pointer to the ID of the created data stream.</param>
        ///
        /// <param name="reliable"> Sets whether the recipients are guaranteed to receive the data stream from the sender within five seconds:
        ///  true: The recipients receive the data stream from the sender within five seconds. If the recipient does not receive the data stream within five seconds, an error is reported to the application.
        ///  false: There is no guarantee that the recipients receive the data stream from the sender within five seconds. The SDK does not report errors if reception is delayed or data is lost. </param>
        ///
        /// <param name="ordered"> Sets whether the recipients receive the data stream in the sent order:
        ///  true: The recipients receive the data stream in the sent order.
        ///  false: There is no guarantee that the recipients receive the data stream in the sent order. </param>
        ///
        /// <returns>
        ...
        /// Creates a data stream.
        /// Creates a data stream. Each user can create up to five data streams in a single channel.
        /// Compared with CreateDataStreamEx [1/2]
        /// </summary>
        ///
        /// <param name="connection"> The connection information. See RtcConnection .</param>
        ///
        ...
        /// Each client can send up to 6 KB of data per second.
        /// Each user can have up to five data streams simultaneously. A successful method call triggers the OnStreamMessage callback on the remote client, from which the remote user gets the stream message. 
        /// A failed method call triggers the OnStreamMessageError callback on the remote client. Ensure that you call CreateDataStreamEx [2/2] to create a data channel before calling this method.
        ...
        /// This method supports adding a watermark image in the PNG file format only. Supported pixel formats of the PNG image are RGBA, RGB, Palette, Gray, and Alpha_gray.
        /// If the dimensions of the PNG image differ from your settings in this method, the image will be cropped or zoomed to conform to your settings.
        /// If you have enabled the local video preview by calling the StartPreview visibleInPreview member to set whether or not the watermark is visible in the preview.
        /// If you have enabled the mirror mode for the local video, the watermark on the local video is also mirrored. To avoid mirroring the watermark, Agora recommends that you do not use the mirror and watermark functions for the local video at the same time. You can implement the watermark function in your application layer.
        /// </summary>
        ///
        /// <param name="connection"> The connection information. See RtcConnection .</param>
