...
namespace Agora.Rtc
{
    ...
    public abstract class IMediaPlayer
    {
        ...
        ///
        /// <summary>
        /// Add callback event for media player.
        /// </summary>
        ///
        ...
        /// </summary>
        ///
        /// <param name="url"> The path of the media file. Both local path and online path are supported.On the Android platform, the URI format is not supported.</param>
        ///
        ...
        /// </summary>
        ///
        /// <param name="mute"> Whether to mute the media file:
        ///  true: Mute the media file.
        ///  false: (Default) Unmute the media file.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="mute"> Output parameter. Whether the media file is muted:
        ///  true: Mute the recording signal.
        ///  false: The media file is unmuted.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// </summary>
        ///
        /// <param name="volume"> The local playback volume, which ranges from 0 to 100:
        ///  0: Mute.
        ...
        /// </summary>
        ///
        /// <param name="volume"> The volume, which ranges from 0 to 400:
        ///  0: Mute.
        ...
        /// </summary>
        ///
        /// <param name="enable"> Whether to enable the automatic switch of the CDN routes for playing the media resource:
        ///  true: Enables the automatic switch of the CDN routes.
        ///  false: (Default) Disables the automatic switch of the CDN routes.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
        ...
        /// <param name="src"> The URL of the media resource.</param>
        ///
        /// <param name="syncPts"> Whether to synchronize the playback position (ms) before and after the switch:
        ///  true: Synchronize the playback position before and after the switch.
        ///  false: (Default) Do not synchronize the playback position before and after the switch. falseMake sure to set this parameter as if you need to play live streams, or the switch fails. If you need to play on-demand streams, you can set the value of this parameter according to your scenarios.</param>
        ///
        /// <returns>
        /// 0: Success.
        /// &lt; 0: Failure.
