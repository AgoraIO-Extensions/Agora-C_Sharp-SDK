...
namespace Agora.Rtc
{
    ...
    public abstract class IMediaPlayer
    {
        ...
        /// You need to implement the IMediaPlayerAudioFrameObserver class in this method and register callbacks according to your scenarios. After you successfully register the audio frame observer, the SDK triggers the registered callbacks each time a audio frame is received.
        /// </summary>
        ///
        ...
        /// This method is called asynchronously. If you need to play a media file, make sure you receive the OnPlayerSourceStateChanged callback reportingPLAYER_STATE_OPEN_COMPLETED before calling the Play method to play the file.
        /// </summary>
        ///
        ...
        /// If you want to loop, call this method and set the number of the loops.When the loop finishes, the SDK triggers OnPlayerSourceStateChanged and reports the playback state asPLAYER_STATE_PLAYBACK_ALL_LOOPS_COMPLETED.
        /// </summary>
        ///
        ...
        /// </summary>
        ///
        /// <param name="token"> The authentication field. See thesign field of the authentication information.</param>
        ///
        /// <param name="ts"> The timestamp when the authentication information expires. See thets field of the authentication information.</param>
        ///
        /// <returns>
        /// 0: Success.< 0: Failure.
        /// </returns>
        ...
        /// After calling the PreloadSrc method to preload the media resource into the playlist, you can call this method to play the preloaded media resource. After calling this method, if you receive the OnPlayerSourceStateChanged callback which reports thePLAYER_STATE_PLAYING state, the playback is successful.If you want to change the preloaded media resource to be played, you can call this method again and specify the URL of the new media resource that you want to preload. If you want to replay the media resource, you need to call PreloadSrc to preload the media resource to the playlist again before playing. If you want to clear the playlist, call the Stop method.If you call this method when playback is paused, this method does not take effect until playback is resumed.
        /// </summary>
        ///
        /// <param name="src"> The URL of the media resource in the playlist must be consistent with thesrc set by thePreloadSrc method; otherwise, the media resource cannot be played.</param>
        ///
        /// <returns>
        /// 0: Success.< 0: Failure.
        /// </returns>
