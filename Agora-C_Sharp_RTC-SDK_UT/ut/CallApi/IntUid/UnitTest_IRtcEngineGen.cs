...
namespace Agora.Rtc.Ut
{
    public partial class UnitTest_IRtcEngine
    {
        ...
        [Test]
        public void Test_AddVideoWatermark_d3b69c4()
        {
            var watermarkImageBuffer = ParamsHelper.CreateParam<ImageBuffer>();

            var options = ParamsHelper.CreateParam<WatermarkOptions>();

            var nRet = @interface.AddVideoWatermark(watermarkImageBuffer, options);
            Assert.AreEqual(0, nRet);
        }
