...
namespace Agora.Rtc.Ut
{
    public partial class UnitTest_IRtcEngine
    {
        ...
        {
            var nRet = @interface.StartEchoTest();
            Assert.AreEqual(0, nRet);
        }


        [Test]
        public void Test_StartEchoTest_46f8ab7()
        {
            var intervalInSeconds = ParamsHelper.CreateParam<int>();

            var nRet = @interface.StartEchoTest(intervalInSeconds);
            Assert.AreEqual(0, nRet);
        }
        ...
        [Test]
        public void Test_SetDefaultMuteAllRemoteAudioStreams_5039d15()
        {
            var mute = ParamsHelper.CreateParam<bool>();

            var nRet = @interface.SetDefaultMuteAllRemoteAudioStreams(mute);
            Assert.AreEqual(0, nRet);
        }
        ...
        [Test]
        public void Test_SetDefaultMuteAllRemoteVideoStreams_5039d15()
        {
            var mute = ParamsHelper.CreateParam<bool>();

            var nRet = @interface.SetDefaultMuteAllRemoteVideoStreams(mute);
            Assert.AreEqual(0, nRet);
        }
        ...
        [Test]
        public void Test_StartScreenCaptureByDisplayId_7cf6800()
        {
        ...
        [Test]
        public void Test_StartScreenCaptureByWindowId_5ab7e59()
        {
            var windowId = ParamsHelper.CreateParam<view_t>();
        ...
        [Test]
        public void Test_SetEncryptionMode_3a2037f()
        {
            var encryptionMode = ParamsHelper.CreateParam<string>();

            var nRet = @interface.SetEncryptionMode(encryptionMode);
            Assert.AreEqual(0, nRet);
        }


        [Test]
        public void Test_SetEncryptionSecret_3a2037f()
        {
            var secret = ParamsHelper.CreateParam<string>();

            var nRet = @interface.SetEncryptionSecret(secret);
            Assert.AreEqual(0, nRet);
        }
