...
namespace Agora.Rtc.Ut.Event
{
    public partial class UnitTest_IRtcEngineEventHandler
    {
        ...
        [Test]
        public void Test_IRtcEngineEventHandler_OnPipStateChanged_941b366()
        {
            ApiParam.@event = AgoraApiType.IRTCENGINEEVENTHANDLER_ONPIPSTATECHANGED_941b366;
            ...
            int ret = DLLHelper.TriggerEventWithFakeRtcEngine(FakeRtcEnginePtr, ref ApiParam);
            Assert.AreEqual(0, ret);
            Assert.AreEqual(false, callback.OnPipStateChangedPassed(state));
        }
        ...
        [Test]
        public void Test_IRtcEngineEventHandler_OnExtensionEvent_062d13c()
        {
            ApiParam.@event = AgoraApiType.IRTCENGINEEVENTHANDLER_ONEXTENSIONEVENT_062d13c;
            ...
            int ret = DLLHelper.TriggerEventWithFakeRtcEngine(FakeRtcEnginePtr, ref ApiParam);
            Assert.AreEqual(0, ret);
            Assert.AreEqual(true, callback.OnExtensionEventPassed(provider, extension, key, value));
        }

        [Test]
        public void Test_IRtcEngineEventHandler_OnExtensionStarted_ccad422()
        {
            ApiParam.@event = AgoraApiType.IRTCENGINEEVENTHANDLER_ONEXTENSIONSTARTED_ccad422;
            ...
            int ret = DLLHelper.TriggerEventWithFakeRtcEngine(FakeRtcEnginePtr, ref ApiParam);
            Assert.AreEqual(0, ret);
            Assert.AreEqual(true, callback.OnExtensionStartedPassed(provider, extension));
        }

        [Test]
        public void Test_IRtcEngineEventHandler_OnExtensionStopped_ccad422()
        {
            ApiParam.@event = AgoraApiType.IRTCENGINEEVENTHANDLER_ONEXTENSIONSTOPPED_ccad422;
            ...
            int ret = DLLHelper.TriggerEventWithFakeRtcEngine(FakeRtcEnginePtr, ref ApiParam);
            Assert.AreEqual(0, ret);
            Assert.AreEqual(true, callback.OnExtensionStoppedPassed(provider, extension));
        }

        [Test]
        public void Test_IRtcEngineEventHandler_OnExtensionError_bd3489b()
        {
            ApiParam.@event = AgoraApiType.IRTCENGINEEVENTHANDLER_ONEXTENSIONERROR_bd3489b;
            ...
            int ret = DLLHelper.TriggerEventWithFakeRtcEngine(FakeRtcEnginePtr, ref ApiParam);
            Assert.AreEqual(0, ret);
            Assert.AreEqual(true, callback.OnExtensionErrorPassed(provider, extension, error, message));
        }
        ...
        [Test]
        public void Test_IRtcEngineEventHandler_OnLocalVideoStateChanged_b202b1b()
        {
            ApiParam.@event = AgoraApiType.IRTCENGINEEVENTHANDLER_ONLOCALVIDEOSTATECHANGED_b202b1b;
            ...
            int ret = DLLHelper.TriggerEventWithFakeRtcEngine(FakeRtcEnginePtr, ref ApiParam);
            Assert.AreEqual(0, ret);
            Assert.AreEqual(true, callback.OnLocalVideoStateChangedPassed(connection, state, reason));
        }
