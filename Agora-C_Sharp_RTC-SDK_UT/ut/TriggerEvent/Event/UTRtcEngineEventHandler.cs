...
#region terra IRtcEngineEventHandler
        ...
        public int OnChannelMediaRelayEvent_code;
        ...
        public bool OnChannelMediaRelayEventPassed(int code)
        {
            if (OnChannelMediaRelayEvent_be_trigger == false)
                return false;
            if (ParamsHelper.Compare<int>(OnChannelMediaRelayEvent_code, code) == false)
                return false;
            return true;
        }
        ...
        public string OnUserAccountUpdated_userAccount;
        ...
        public bool OnUserAccountUpdatedPassed(RtcConnection connection, uint remoteUid, string userAccount)
        {
            ...
            if (ParamsHelper.Compare<uint>(OnUserAccountUpdated_remoteUid, remoteUid) == false)
                return false;
            if (ParamsHelper.Compare<string>(OnUserAccountUpdated_userAccount, userAccount) == false)
                return false;
            return true;
        }
