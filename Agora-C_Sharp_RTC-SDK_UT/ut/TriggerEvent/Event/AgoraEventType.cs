...
namespace Agora.Rtc
{
    public class AgoraEventType
    {
        ...
        internal const string EVENT_RTMEVENTHANDLER_ONGETONLINEUSERSRESULT = "RtmEventHandler_onGetOnlineUsersResult";
        internal const string EVENT_RTMEVENTHANDLER_ONGETUSERCHANNELSRESULT = "RtmEventHandler_onGetUserChannelsResult";
