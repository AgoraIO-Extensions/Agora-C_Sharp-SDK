...
namespace Agora.Rtc
{
    public class UTAudioFrameObserver : IAudioFrameObserver
    {
        ...
        public bool GetObservedAudioFramePosition_be_trigger = false;

        public override int GetObservedAudioFramePosition()
        {
            GetObservedAudioFramePosition_be_trigger = true;
            return 1;
        }

        public bool GetObservedAudioFramePositionPassed()
        {
            if (GetObservedAudioFramePosition_be_trigger == false)
                return false;
        ...
        public bool GetPlaybackAudioParams_be_trigger = false;

        public override AudioParams GetPlaybackAudioParams()
        {
            GetPlaybackAudioParams_be_trigger = true;
            return new AudioParams();
        }

        public bool GetPlaybackAudioParamsPassed()
        {
        ...
        public bool GetRecordAudioParamsPassed()
        {
            if (GetRecordAudioParams_be_trigger == false)
                return false;
        ...
        public bool GetMixedAudioParams_be_trigger = false;

        public override AudioParams GetMixedAudioParams() { GetMixedAudioParams_be_trigger = true; return new AudioParams(); }

        public bool GetMixedAudioParamsPassed()
        {
            if (GetMixedAudioParams_be_trigger == false)
                return false;
        ...
        public bool GetEarMonitoringAudioParams_be_trigger = false;

        public override AudioParams GetEarMonitoringAudioParams() { GetEarMonitoringAudioParams_be_trigger = true; return new AudioParams(); }

        public bool GetEarMonitoringAudioParamsPassed()
        {
            if (GetEarMonitoringAudioParams_be_trigger == false)
                return false;
